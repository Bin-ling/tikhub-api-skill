...
class ToutiaoAppAPIApi(object):
    ...
    def get_article_info_api_v1_toutiao_app_get_article_info_get(self, group_id, **kwargs):  # noqa: E501
        ...
        :param object group_id: 作品ID/Post ID (required)
        :return: None
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_article_info_api_v1_toutiao_app_get_article_info_get_with_http_info(group_id, **kwargs)  # noqa: E501
            return data
    ...
    def get_article_info_api_v1_toutiao_app_get_article_info_get_with_http_info(self, group_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('group_id' not in params or
            ...
            raise ValueError("Missing the required parameter `group_id` when calling `get_article_info_api_v1_toutiao_app_get_article_info_get`")  # noqa: E501
    ...
    def get_comments_api_v1_toutiao_app_get_comments_get(self, group_id, offset, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param object group_id: 作品ID/Post ID (required)
        :param object offset: 偏移量/Offset (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_comments_api_v1_toutiao_app_get_comments_get_with_http_info(group_id, offset, **kwargs)  # noqa: E501
            return data
    ...
    def get_comments_api_v1_toutiao_app_get_comments_get_with_http_info(self, group_id, offset, **kwargs):  # noqa: E501
        ...
        all_params = ['group_id', 'offset']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('group_id' not in params or
                                                       params['group_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `group_id` when calling `get_comments_api_v1_toutiao_app_get_comments_get`")  # noqa: E501
        # verify the required parameter 'offset' is set
        if self.api_client.client_side_validation and ('offset' not in params or
                                                       params['offset'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `offset` when calling `get_comments_api_v1_toutiao_app_get_comments_get`")  # noqa: E501
    ...
    def get_user_id_api_v1_toutiao_app_get_user_id_get(self, user_profile_url, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param object user_profile_url: 用户主页链接/User profile URL (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_user_id_api_v1_toutiao_app_get_user_id_get_with_http_info(user_profile_url, **kwargs)  # noqa: E501
            return data
    ...
    def get_user_id_api_v1_toutiao_app_get_user_id_get_with_http_info(self, user_profile_url, **kwargs):  # noqa: E501
        ...
        all_params = ['user_profile_url']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('user_profile_url' not in params or
                                                       params['user_profile_url'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `user_profile_url` when calling `get_user_id_api_v1_toutiao_app_get_user_id_get`")  # noqa: E501
        ...
        query_params = []
        if 'user_profile_url' in params:
            query_params.append(('user_profile_url', params['user_profile_url']))  # noqa: E501
    ...
    def get_user_info_api_v1_toutiao_app_get_user_info_get(self, user_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_user_info_api_v1_toutiao_app_get_user_info_get_with_http_info(user_id, **kwargs)  # noqa: E501
            return data
    ...
    def get_user_info_api_v1_toutiao_app_get_user_info_get_with_http_info(self, user_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('user_id' not in params or
            ...
            raise ValueError("Missing the required parameter `user_id` when calling `get_user_info_api_v1_toutiao_app_get_user_info_get`")  # noqa: E501
    ...
    def get_video_info_api_v1_toutiao_app_get_video_info_get(self, group_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_video_info_api_v1_toutiao_app_get_video_info_get_with_http_info(group_id, **kwargs)  # noqa: E501
            return data
    ...
    def get_video_info_api_v1_toutiao_app_get_video_info_get_with_http_info(self, group_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('group_id' not in params or
                                                       params['group_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `group_id` when calling `get_video_info_api_v1_toutiao_app_get_video_info_get`")  # noqa: E501

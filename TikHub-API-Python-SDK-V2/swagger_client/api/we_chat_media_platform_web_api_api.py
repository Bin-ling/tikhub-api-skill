...
class WeChatMediaPlatformWebAPIApi(object):
    ...
    def fetch_mp_article_ad_api_v1_wechat_mp_web_fetch_mp_article_ad_get(self, url, **kwargs):  # noqa: E501
        ...
        :param object url: 文章链接/Article URL (required)
        :return: None
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.fetch_mp_article_ad_api_v1_wechat_mp_web_fetch_mp_article_ad_get_with_http_info(url, **kwargs)  # noqa: E501
            return data
    ...
    def fetch_mp_article_ad_api_v1_wechat_mp_web_fetch_mp_article_ad_get_with_http_info(self, url, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('url' not in params or
            ...
            raise ValueError("Missing the required parameter `url` when calling `fetch_mp_article_ad_api_v1_wechat_mp_web_fetch_mp_article_ad_get`")  # noqa: E501
    ...
    def fetch_mp_article_comment_list_api_v1_wechat_mp_web_fetch_mp_article_comment_list_get(self, url, **kwargs):  # noqa: E501
        ...
        # [中文] ### 用途: - 获取微信公众号文章评论列表 ### 参数: - url: 文章链接 - comment_id: 评论ID，可以不传获取评论用的id，默认传空字符串 - buffer: 偏移量，第一次传空字符串，后续传上次返回的buffer值 ### 返回: - 评论列表  # [English] ### Purpose: - Get Wechat MP Article Comment List ### Parameters: - url: Article URL - comment_id: Comment ID, can be empty to get the comment ID, default is an empty string - buffer: Offset, first time is an empty string, then pass the buffer value returned last time ### Returns: - Comment List  # [示例/Example] url = \"https://mp.weixin.qq.com/s/Iv-xRzL7WzbL0dUUIgi3Nw\" comment_id = \"\" buffer = \"0\"  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param object url: 文章链接/Article URL (required)
        :param object comment_id: 评论ID/Comment ID
        :param object buffer: 偏移量/Offset
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.fetch_mp_article_comment_list_api_v1_wechat_mp_web_fetch_mp_article_comment_list_get_with_http_info(url, **kwargs)  # noqa: E501
            return data
    ...
    def fetch_mp_article_comment_list_api_v1_wechat_mp_web_fetch_mp_article_comment_list_get_with_http_info(self, url, **kwargs):  # noqa: E501
        ...
        all_params = ['url', 'comment_id', 'buffer']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('url' not in params or
                                                       params['url'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `url` when calling `fetch_mp_article_comment_list_api_v1_wechat_mp_web_fetch_mp_article_comment_list_get`")  # noqa: E501
        ...
        if 'buffer' in params:
            query_params.append(('buffer', params['buffer']))  # noqa: E501
    ...
    def fetch_mp_article_comment_reply_list_api_v1_wechat_mp_web_fetch_mp_article_comment_reply_list_get(self, comment_id, content_id, **kwargs):  # noqa: E501
        ...
        :param object content_id: 内容ID/Content ID (required)
        :param object url: 文章链接/Article URL
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.fetch_mp_article_comment_reply_list_api_v1_wechat_mp_web_fetch_mp_article_comment_reply_list_get_with_http_info(comment_id, content_id, **kwargs)  # noqa: E501
            return data
    ...
    def fetch_mp_article_comment_reply_list_api_v1_wechat_mp_web_fetch_mp_article_comment_reply_list_get_with_http_info(self, comment_id, content_id, **kwargs):  # noqa: E501
        ...
        all_params = ['comment_id', 'content_id', 'url', 'offset']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('comment_id' not in params or
            ...
            raise ValueError("Missing the required parameter `comment_id` when calling `fetch_mp_article_comment_reply_list_api_v1_wechat_mp_web_fetch_mp_article_comment_reply_list_get`")  # noqa: E501
        # verify the required parameter 'content_id' is set
        if self.api_client.client_side_validation and ('content_id' not in params or
                                                       params['content_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `content_id` when calling `fetch_mp_article_comment_reply_list_api_v1_wechat_mp_web_fetch_mp_article_comment_reply_list_get`")  # noqa: E501
        ...
        if 'content_id' in params:
            query_params.append(('content_id', params['content_id']))  # noqa: E501
        if 'offset' in params:
    ...
    def fetch_mp_article_detail_html_api_v1_wechat_mp_web_fetch_mp_article_detail_html_get(self, url, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.fetch_mp_article_detail_html_api_v1_wechat_mp_web_fetch_mp_article_detail_html_get_with_http_info(url, **kwargs)  # noqa: E501
            return data
    ...
    def fetch_mp_article_detail_html_api_v1_wechat_mp_web_fetch_mp_article_detail_html_get_with_http_info(self, url, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('url' not in params or
                                                       params['url'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `url` when calling `fetch_mp_article_detail_html_api_v1_wechat_mp_web_fetch_mp_article_detail_html_get`")  # noqa: E501
    ...
    def fetch_mp_article_detail_json_api_v1_wechat_mp_web_fetch_mp_article_detail_json_get(self, url, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.fetch_mp_article_detail_json_api_v1_wechat_mp_web_fetch_mp_article_detail_json_get_with_http_info(url, **kwargs)  # noqa: E501
            return data
    ...
    def fetch_mp_article_detail_json_api_v1_wechat_mp_web_fetch_mp_article_detail_json_get_with_http_info(self, url, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('url' not in params or
                                                       params['url'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `url` when calling `fetch_mp_article_detail_json_api_v1_wechat_mp_web_fetch_mp_article_detail_json_get`")  # noqa: E501
    ...
    def fetch_mp_article_list_api_v1_wechat_mp_web_fetch_mp_article_list_get(self, ghid, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param object ghid: 公众号ID/MP ID (required)
        :param object offset: 偏移量/Offset
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.fetch_mp_article_list_api_v1_wechat_mp_web_fetch_mp_article_list_get_with_http_info(ghid, **kwargs)  # noqa: E501
            return data
    ...
    def fetch_mp_article_list_api_v1_wechat_mp_web_fetch_mp_article_list_get_with_http_info(self, ghid, **kwargs):  # noqa: E501
        ...
        all_params = ['ghid', 'offset']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('ghid' not in params or
                                                       params['ghid'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `ghid` when calling `fetch_mp_article_list_api_v1_wechat_mp_web_fetch_mp_article_list_get`")  # noqa: E501
        ...
        query_params = []
        if 'ghid' in params:
            query_params.append(('ghid', params['ghid']))  # noqa: E501
        if 'offset' in params:
            query_params.append(('offset', params['offset']))  # noqa: E501
    ...
    def fetch_mp_article_read_count_api_v1_wechat_mp_web_fetch_mp_article_read_count_get(self, url, comment_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.fetch_mp_article_read_count_api_v1_wechat_mp_web_fetch_mp_article_read_count_get_with_http_info(url, comment_id, **kwargs)  # noqa: E501
            return data
    ...
    def fetch_mp_article_read_count_api_v1_wechat_mp_web_fetch_mp_article_read_count_get_with_http_info(self, url, comment_id, **kwargs):  # noqa: E501
        ...
        all_params = ['url', 'comment_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('url' not in params or
                                                       params['url'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `url` when calling `fetch_mp_article_read_count_api_v1_wechat_mp_web_fetch_mp_article_read_count_get`")  # noqa: E501
        # verify the required parameter 'comment_id' is set
        if self.api_client.client_side_validation and ('comment_id' not in params or
                                                       params['comment_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `comment_id` when calling `fetch_mp_article_read_count_api_v1_wechat_mp_web_fetch_mp_article_read_count_get`")  # noqa: E501
    ...
    def fetch_mp_article_url_api_v1_wechat_mp_web_fetch_mp_article_url_get(self, sogou_url, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param object sogou_url: 搜狗链接/Sogou URL (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.fetch_mp_article_url_api_v1_wechat_mp_web_fetch_mp_article_url_get_with_http_info(sogou_url, **kwargs)  # noqa: E501
            return data
    ...
    def fetch_mp_article_url_api_v1_wechat_mp_web_fetch_mp_article_url_get_with_http_info(self, sogou_url, **kwargs):  # noqa: E501
        ...
        all_params = ['sogou_url']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('sogou_url' not in params or
                                                       params['sogou_url'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `sogou_url` when calling `fetch_mp_article_url_api_v1_wechat_mp_web_fetch_mp_article_url_get`")  # noqa: E501
        ...
        query_params = []
        if 'sogou_url' in params:
            query_params.append(('sogou_url', params['sogou_url']))  # noqa: E501
    ...
    def fetch_mp_article_url_conversion_api_v1_wechat_mp_web_fetch_mp_article_url_conversion_get(self, url, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.fetch_mp_article_url_conversion_api_v1_wechat_mp_web_fetch_mp_article_url_conversion_get_with_http_info(url, **kwargs)  # noqa: E501
            return data
    ...
    def fetch_mp_article_url_conversion_api_v1_wechat_mp_web_fetch_mp_article_url_conversion_get_with_http_info(self, url, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('url' not in params or
                                                       params['url'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `url` when calling `fetch_mp_article_url_conversion_api_v1_wechat_mp_web_fetch_mp_article_url_conversion_get`")  # noqa: E501
    ...
    def fetch_mp_related_articles_api_v1_wechat_mp_web_fetch_mp_related_articles_get(self, url, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.fetch_mp_related_articles_api_v1_wechat_mp_web_fetch_mp_related_articles_get_with_http_info(url, **kwargs)  # noqa: E501
            return data
    ...
    def fetch_mp_related_articles_api_v1_wechat_mp_web_fetch_mp_related_articles_get_with_http_info(self, url, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('url' not in params or
                                                       params['url'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `url` when calling `fetch_mp_related_articles_api_v1_wechat_mp_web_fetch_mp_related_articles_get`")  # noqa: E501

...
class TikHubDownloaderAPIApi(object):
    ...
    def redirect_download_api_v1_tikhub_downloader_redirect_download_get(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.redirect_download_api_v1_tikhub_downloader_redirect_download_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.redirect_download_api_v1_tikhub_downloader_redirect_download_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def redirect_download_api_v1_tikhub_downloader_redirect_download_get_with_http_info(self, **kwargs):  # noqa: E501
        """重定向到最新版本的下载链接 / Redirect to the latest version download link  # noqa: E501

        # [中文]  ### 用途说明:  - 该接口用于检测客户端操作系统，并重定向到相应的 GitHub Release 直链，方便用户请求后直接开始下载最新版本的文件。  ### 参数说明:  - 无参数。  ### 返回结果:  - Windows 用户：重定向到 `.exe` 下载地址。 - Mac 用户：重定向到 `.zip` 下载地址。 - 其他用户：重定向到 GitHub Release 页面。  # [English]  ### Purpose:  - This endpoint detects the client operating system and redirects to the corresponding GitHub Release direct link, allowing users to start downloading the latest version file immediately.  ### Parameter Description:  - No parameters.  ### Return Result:  - Windows users: Redirect to `.exe` download URL. - Mac users: Redirect to `.zip` download URL. - Other users: Redirect to the GitHub Release page.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.redirect_download_api_v1_tikhub_downloader_redirect_download_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method redirect_download_api_v1_tikhub_downloader_redirect_download_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/v1/tikhub/downloader/redirect_download', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_check_api_v1_tikhub_downloader_version_get(self, **kwargs):  # noqa: E501
        """检查TikHub下载器的版本更新 / Check for TikHub Downloader version updates  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_check_api_v1_tikhub_downloader_version_get(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_check_api_v1_tikhub_downloader_version_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.update_check_api_v1_tikhub_downloader_version_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def update_check_api_v1_tikhub_downloader_version_get_with_http_info(self, **kwargs):  # noqa: E501
        """检查TikHub下载器的版本更新 / Check for TikHub Downloader version updates  # noqa: E501

        # [中文]  ### 用途说明:  - 检查TikHub下载器的版本更新。  ### 参数说明:  - 无参数。  ### 返回结果:  - `latest_version`: 最新版本号。 - `update_date`: 更新日期。 - `download_url`: 下载链接。 - `upload_note`: 更新说明。  # [English]  ### Purpose:  - Check for TikHub Downloader version updates.  ### Parameter Description:  - No parameters.  ### Return Result:  - `latest_version`: Latest version number. - `update_date`: Update date. - `download_url`: Download link. - `upload_note`: Update note.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_check_api_v1_tikhub_downloader_version_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_check_api_v1_tikhub_downloader_version_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/v1/tikhub/downloader/version', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,

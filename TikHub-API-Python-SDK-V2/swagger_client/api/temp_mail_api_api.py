...
class TempMailAPIApi(object):
    ...
    def get_email_by_id_api_v1_temp_mail_v1_get_email_by_id_get(self, token, message_id, **kwargs):  # noqa: E501
        ...
        :param object token: Bearer Token (required)
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_email_by_id_api_v1_temp_mail_v1_get_email_by_id_get_with_http_info(token, message_id, **kwargs)  # noqa: E501
            return data
    ...
    def get_email_by_id_api_v1_temp_mail_v1_get_email_by_id_get_with_http_info(self, token, message_id, **kwargs):  # noqa: E501
        ...
        all_params = ['token', 'message_id']  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('token' not in params or
            ...
            raise ValueError("Missing the required parameter `token` when calling `get_email_by_id_api_v1_temp_mail_v1_get_email_by_id_get`")  # noqa: E501
        # verify the required parameter 'message_id' is set
        if self.api_client.client_side_validation and ('message_id' not in params or
                                                       params['message_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `message_id` when calling `get_email_by_id_api_v1_temp_mail_v1_get_email_by_id_get`")  # noqa: E501
    ...
    def get_emails_api_v1_temp_mail_v1_get_emails_inbox_get(self, token, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_emails_api_v1_temp_mail_v1_get_emails_inbox_get_with_http_info(token, **kwargs)  # noqa: E501
            return data
    ...
    def get_emails_api_v1_temp_mail_v1_get_emails_inbox_get_with_http_info(self, token, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('token' not in params or
                                                       params['token'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `token` when calling `get_emails_api_v1_temp_mail_v1_get_emails_inbox_get`")  # noqa: E501
    ...
    def get_temp_email_api_v1_temp_mail_v1_get_temp_email_address_get(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_temp_email_api_v1_temp_mail_v1_get_temp_email_address_get_with_http_info(**kwargs)  # noqa: E501
            return data

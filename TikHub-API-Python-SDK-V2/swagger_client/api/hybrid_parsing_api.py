...
class HybridParsingApi(object):
    ...
    def hybrid_parsing_single_video_api_v1_hybrid_video_data_get(self, url, **kwargs):  # noqa: E501
        ...
        :param object minimal: 是否返回最小数据/Whether to return minimal data
        :param object base64_url: 是否Base64编码提交URL/Base64 encoding URL
        :return: None
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.hybrid_parsing_single_video_api_v1_hybrid_video_data_get_with_http_info(url, **kwargs)  # noqa: E501
            return data
    ...
    def hybrid_parsing_single_video_api_v1_hybrid_video_data_get_with_http_info(self, url, **kwargs):  # noqa: E501
        ...
        all_params = ['url', 'minimal', 'base64_url']  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('url' not in params or
            ...
            raise ValueError("Missing the required parameter `url` when calling `hybrid_parsing_single_video_api_v1_hybrid_video_data_get`")  # noqa: E501
        ...
        if 'base64_url' in params:
            query_params.append(('base64_url', params['base64_url']))  # noqa: E501
    ...
    def hybrid_parsing_single_video_api_v1_hybrid_video_data_get_0(self, url, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.hybrid_parsing_single_video_api_v1_hybrid_video_data_get_0_with_http_info(url, **kwargs)  # noqa: E501
            return data
    ...
    def hybrid_parsing_single_video_api_v1_hybrid_video_data_get_0_with_http_info(self, url, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('url' not in params or
                                                       params['url'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `url` when calling `hybrid_parsing_single_video_api_v1_hybrid_video_data_get_0`")  # noqa: E501

...
from swagger_client.api.tik_tok_shop_web_api_api import TikTokShopWebAPIApi  # noqa: E501
from swagger_client.rest import ApiException


class TestTikTokShopWebAPIApi(unittest.TestCase):
    """TikTokShopWebAPIApi unit test stubs"""

    def setUp(self):
        self.api = swagger_client.api.tik_tok_shop_web_api_api.TikTokShopWebAPIApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_fetch_hot_selling_products_list_api_v1_tiktok_shop_web_fetch_hot_selling_products_list_get(self):
        """Test case for fetch_hot_selling_products_list_api_v1_tiktok_shop_web_fetch_hot_selling_products_list_get

        获取热卖商品列表/Get hot selling products list  # noqa: E501
        """
        pass

    def test_fetch_product_detail_api_v1_tiktok_shop_web_fetch_product_detail_get(self):
        """Test case for fetch_product_detail_api_v1_tiktok_shop_web_fetch_product_detail_get

        获取商品详情V1(桌面端-数据完整)/Get product detail V1(Full data)  # noqa: E501
        """
        pass

    def test_fetch_product_detail_v2_api_v1_tiktok_shop_web_fetch_product_detail_v2_get(self):
        """Test case for fetch_product_detail_v2_api_v1_tiktok_shop_web_fetch_product_detail_v2_get

        获取商品详情V2(移动端-数据少)/Get product detail V2 (Less Data)  # noqa: E501
        """
        pass

    def test_fetch_product_detail_v3_api_v1_tiktok_shop_web_fetch_product_detail_v3_get(self):
        """Test case for fetch_product_detail_v3_api_v1_tiktok_shop_web_fetch_product_detail_v3_get

        获取商品详情V3(移动端-数据完整)/Get product detail V3 (Full Data)  # noqa: E501
        """
        pass

    def test_fetch_product_reviews_v1_api_v1_tiktok_shop_web_fetch_product_reviews_v1_get(self):
        """Test case for fetch_product_reviews_v1_api_v1_tiktok_shop_web_fetch_product_reviews_v1_get

        获取商品评论V1/Get product reviews V1  # noqa: E501
        """
        pass

    def test_fetch_product_reviews_v2_api_v1_tiktok_shop_web_fetch_product_reviews_v2_get(self):
        """Test case for fetch_product_reviews_v2_api_v1_tiktok_shop_web_fetch_product_reviews_v2_get

        获取商品评论V2/Get product reviews V2  # noqa: E501
        """
        pass

    def test_fetch_products_by_category_id_api_v1_tiktok_shop_web_fetch_products_by_category_id_get(self):
        """Test case for fetch_products_by_category_id_api_v1_tiktok_shop_web_fetch_products_by_category_id_get

        根据分类ID获取商品列表/Get products by category ID  # noqa: E501
        """
        pass

    def test_fetch_products_category_list_api_v1_tiktok_shop_web_fetch_products_category_list_get(self):
        """Test case for fetch_products_category_list_api_v1_tiktok_shop_web_fetch_products_category_list_get

        获取商品分类列表/Get product category list  # noqa: E501
        """
        pass

    def test_fetch_search_products_list_api_v1_tiktok_shop_web_fetch_search_products_list_get(self):
        """Test case for fetch_search_products_list_api_v1_tiktok_shop_web_fetch_search_products_list_get

        搜索商品列表V1/Search products list V1  # noqa: E501
        """
        pass

    def test_fetch_search_products_list_v2_api_v1_tiktok_shop_web_fetch_search_products_list_v2_get(self):
        """Test case for fetch_search_products_list_v2_api_v1_tiktok_shop_web_fetch_search_products_list_v2_get

        搜索商品列表V2(移动端)/Search products list V2 (Mobile)  # noqa: E501
        """
        pass

    def test_fetch_search_products_list_v3_api_v1_tiktok_shop_web_fetch_search_products_list_v3_get(self):
        """Test case for fetch_search_products_list_v3_api_v1_tiktok_shop_web_fetch_search_products_list_v3_get

        搜索商品列表V3/Search products list V3  # noqa: E501
        """
        pass

    def test_fetch_search_word_suggestion_api_v1_tiktok_shop_web_fetch_search_word_suggestion_get(self):
        """Test case for fetch_search_word_suggestion_api_v1_tiktok_shop_web_fetch_search_word_suggestion_get

        获取搜索关键词建议V1/Get search keyword suggestions V1  # noqa: E501
        """
        pass

    def test_fetch_search_word_suggestion_v2_api_v1_tiktok_shop_web_fetch_search_word_suggestion_v2_get(self):
        """Test case for fetch_search_word_suggestion_v2_api_v1_tiktok_shop_web_fetch_search_word_suggestion_v2_get

        获取搜索关键词建议V2(移动端)/Get search keyword suggestions V2 (Mobile)  # noqa: E501
        """
        pass

    def test_fetch_seller_products_list_api_v1_tiktok_shop_web_fetch_seller_products_list_get(self):
        """Test case for fetch_seller_products_list_api_v1_tiktok_shop_web_fetch_seller_products_list_get

        获取商家商品列表V1/Get seller products list V1  # noqa: E501
        """
        pass

    def test_fetch_seller_products_list_v2_api_v1_tiktok_shop_web_fetch_seller_products_list_v2_get(self):
        """Test case for fetch_seller_products_list_v2_api_v1_tiktok_shop_web_fetch_seller_products_list_v2_get

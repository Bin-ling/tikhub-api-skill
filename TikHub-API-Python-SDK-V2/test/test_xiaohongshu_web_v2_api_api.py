...
from swagger_client.api.xiaohongshu_web_v2_api_api import XiaohongshuWebV2APIApi  # noqa: E501
...
class TestXiaohongshuWebV2APIApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = swagger_client.api.xiaohongshu_web_v2_api_api.XiaohongshuWebV2APIApi()  # noqa: E501
    ...
    def test_fetch_feed_notes_v2_api_v1_xiaohongshu_web_v2_fetch_feed_notes_v2_get(self):
        """Test case for fetch_feed_notes_v2_api_v1_xiaohongshu_web_v2_fetch_feed_notes_v2_get

        获取单一笔记和推荐笔记 V2/Fetch one note and feed notes V2(v2稳定, 推荐使用此接口)  # noqa: E501
        """
        pass

    def test_fetch_feed_notes_v3_api_v1_xiaohongshu_web_v2_fetch_feed_notes_v3_get(self):
        """Test case for fetch_feed_notes_v3_api_v1_xiaohongshu_web_v2_fetch_feed_notes_v3_get

        获取单一笔记和推荐笔记 V3/Fetch one note and feed notes V3(通过短链获取笔记详情)  # noqa: E501
        """
        pass

    def test_fetch_feed_notes_v4_api_v1_xiaohongshu_web_v2_fetch_feed_notes_v4_get(self):
        """Test case for fetch_feed_notes_v4_api_v1_xiaohongshu_web_v2_fetch_feed_notes_v4_get

        获取单一笔记和推荐笔记 V4 (互动量有延迟)/Fetch one note and feed notes V4 (interaction volume has a delay)  # noqa: E501
        """
        pass

    def test_fetch_feed_notes_v5_api_v1_xiaohongshu_web_v2_fetch_feed_notes_v5_get(self):
        """Test case for fetch_feed_notes_v5_api_v1_xiaohongshu_web_v2_fetch_feed_notes_v5_get
    ...
    def test_fetch_home_notes_app_api_v1_xiaohongshu_web_v2_fetch_home_notes_app_get(self):
        """Test case for fetch_home_notes_app_api_v1_xiaohongshu_web_v2_fetch_home_notes_app_get

        获取App用户主页笔记/Fetch App user home notes  # noqa: E501
        """
        pass

    def test_fetch_hot_list_api_v1_xiaohongshu_web_v2_fetch_hot_list_get(self):
        """Test case for fetch_hot_list_api_v1_xiaohongshu_web_v2_fetch_hot_list_get
    ...
    def test_fetch_note_image_api_v1_xiaohongshu_web_v2_fetch_note_image_get(self):
        """Test case for fetch_note_image_api_v1_xiaohongshu_web_v2_fetch_note_image_get

        获取小红书笔记图片/Fetch Xiaohongshu note image  # noqa: E501
        """
        pass

    def test_fetch_product_list_api_v1_xiaohongshu_web_v2_fetch_product_list_get(self):
        """Test case for fetch_product_list_api_v1_xiaohongshu_web_v2_fetch_product_list_get
    ...
    def test_fetch_search_notes_api_v1_xiaohongshu_web_v2_fetch_search_users_get(self):
        """Test case for fetch_search_notes_api_v1_xiaohongshu_web_v2_fetch_search_users_get
    ...
    def test_fetch_user_info_api_v1_xiaohongshu_web_v2_fetch_user_info_app_get(self):
        """Test case for fetch_user_info_api_v1_xiaohongshu_web_v2_fetch_user_info_app_get

# swagger_client.TikTokInteractionAPIApi
...
> apply_for_scope_api_v1_tiktok_interaction_apply_get(api_key, invite_code)
...
api_instance = swagger_client.TikTokInteractionAPIApi()
api_key = NULL # object | 
invite_code = NULL # object | 

try:
    # 申请使用TikTok交互API权限（Scope）/Apply for TikTok Interaction API permission (Scope)
    api_instance.apply_for_scope_api_v1_tiktok_interaction_apply_get(api_key, invite_code)
...
try:
    # 收藏/Collect
    api_instance.collect_api_v1_tiktok_interaction_collect_post()
except ApiException as e:
...
try:
    # 关注/Follow
    api_instance.follow_api_v1_tiktok_interaction_follow_post()
except ApiException as e:
...
try:
    # 转发/Forward
    api_instance.forward_api_v1_tiktok_interaction_forward_post()
except ApiException as e:
...
try:
    # 点赞/Like
    api_instance.like_api_v1_tiktok_interaction_like_post()
except ApiException as e:
...
try:
    # 发送评论/Post comment
    api_instance.post_comment_api_v1_tiktok_interaction_post_comment_post()
except ApiException as e:
...
try:
    # 回复评论/Reply to comment
    api_instance.reply_comment_api_v1_tiktok_interaction_reply_comment_post()
except ApiException as e:

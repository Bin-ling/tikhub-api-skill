# swagger_client.TikTokShopWebAPIApi

All URIs are relative to *https://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**fetch_hot_selling_products_list_api_v1_tiktok_shop_web_fetch_hot_selling_products_list_get**](TikTokShopWebAPIApi.md#fetch_hot_selling_products_list_api_v1_tiktok_shop_web_fetch_hot_selling_products_list_get) | **GET** /api/v1/tiktok/shop/web/fetch_hot_selling_products_list | 获取热卖商品列表/Get hot selling products list
[**fetch_product_detail_api_v1_tiktok_shop_web_fetch_product_detail_get**](TikTokShopWebAPIApi.md#fetch_product_detail_api_v1_tiktok_shop_web_fetch_product_detail_get) | **GET** /api/v1/tiktok/shop/web/fetch_product_detail | 获取商品详情V1(桌面端-数据完整)/Get product detail V1(Full data)
[**fetch_product_detail_v2_api_v1_tiktok_shop_web_fetch_product_detail_v2_get**](TikTokShopWebAPIApi.md#fetch_product_detail_v2_api_v1_tiktok_shop_web_fetch_product_detail_v2_get) | **GET** /api/v1/tiktok/shop/web/fetch_product_detail_v2 | 获取商品详情V2(移动端-数据少)/Get product detail V2 (Less Data)
[**fetch_product_detail_v3_api_v1_tiktok_shop_web_fetch_product_detail_v3_get**](TikTokShopWebAPIApi.md#fetch_product_detail_v3_api_v1_tiktok_shop_web_fetch_product_detail_v3_get) | **GET** /api/v1/tiktok/shop/web/fetch_product_detail_v3 | 获取商品详情V3(移动端-数据完整)/Get product detail V3 (Full Data)
[**fetch_product_reviews_v1_api_v1_tiktok_shop_web_fetch_product_reviews_v1_get**](TikTokShopWebAPIApi.md#fetch_product_reviews_v1_api_v1_tiktok_shop_web_fetch_product_reviews_v1_get) | **GET** /api/v1/tiktok/shop/web/fetch_product_reviews_v1 | 获取商品评论V1/Get product reviews V1
[**fetch_product_reviews_v2_api_v1_tiktok_shop_web_fetch_product_reviews_v2_get**](TikTokShopWebAPIApi.md#fetch_product_reviews_v2_api_v1_tiktok_shop_web_fetch_product_reviews_v2_get) | **GET** /api/v1/tiktok/shop/web/fetch_product_reviews_v2 | 获取商品评论V2/Get product reviews V2
[**fetch_products_by_category_id_api_v1_tiktok_shop_web_fetch_products_by_category_id_get**](TikTokShopWebAPIApi.md#fetch_products_by_category_id_api_v1_tiktok_shop_web_fetch_products_by_category_id_get) | **GET** /api/v1/tiktok/shop/web/fetch_products_by_category_id | 根据分类ID获取商品列表/Get products by category ID
[**fetch_products_category_list_api_v1_tiktok_shop_web_fetch_products_category_list_get**](TikTokShopWebAPIApi.md#fetch_products_category_list_api_v1_tiktok_shop_web_fetch_products_category_list_get) | **GET** /api/v1/tiktok/shop/web/fetch_products_category_list | 获取商品分类列表/Get product category list
[**fetch_search_products_list_api_v1_tiktok_shop_web_fetch_search_products_list_get**](TikTokShopWebAPIApi.md#fetch_search_products_list_api_v1_tiktok_shop_web_fetch_search_products_list_get) | **GET** /api/v1/tiktok/shop/web/fetch_search_products_list | 搜索商品列表V1/Search products list V1
[**fetch_search_products_list_v2_api_v1_tiktok_shop_web_fetch_search_products_list_v2_get**](TikTokShopWebAPIApi.md#fetch_search_products_list_v2_api_v1_tiktok_shop_web_fetch_search_products_list_v2_get) | **GET** /api/v1/tiktok/shop/web/fetch_search_products_list_v2 | 搜索商品列表V2(移动端)/Search products list V2 (Mobile)
[**fetch_search_products_list_v3_api_v1_tiktok_shop_web_fetch_search_products_list_v3_get**](TikTokShopWebAPIApi.md#fetch_search_products_list_v3_api_v1_tiktok_shop_web_fetch_search_products_list_v3_get) | **GET** /api/v1/tiktok/shop/web/fetch_search_products_list_v3 | 搜索商品列表V3/Search products list V3
[**fetch_search_word_suggestion_api_v1_tiktok_shop_web_fetch_search_word_suggestion_get**](TikTokShopWebAPIApi.md#fetch_search_word_suggestion_api_v1_tiktok_shop_web_fetch_search_word_suggestion_get) | **GET** /api/v1/tiktok/shop/web/fetch_search_word_suggestion | 获取搜索关键词建议V1/Get search keyword suggestions V1
[**fetch_search_word_suggestion_v2_api_v1_tiktok_shop_web_fetch_search_word_suggestion_v2_get**](TikTokShopWebAPIApi.md#fetch_search_word_suggestion_v2_api_v1_tiktok_shop_web_fetch_search_word_suggestion_v2_get) | **GET** /api/v1/tiktok/shop/web/fetch_search_word_suggestion_v2 | 获取搜索关键词建议V2(移动端)/Get search keyword suggestions V2 (Mobile)
[**fetch_seller_products_list_api_v1_tiktok_shop_web_fetch_seller_products_list_get**](TikTokShopWebAPIApi.md#fetch_seller_products_list_api_v1_tiktok_shop_web_fetch_seller_products_list_get) | **GET** /api/v1/tiktok/shop/web/fetch_seller_products_list | 获取商家商品列表V1/Get seller products list V1
[**fetch_seller_products_list_v2_api_v1_tiktok_shop_web_fetch_seller_products_list_v2_get**](TikTokShopWebAPIApi.md#fetch_seller_products_list_v2_api_v1_tiktok_shop_web_fetch_seller_products_list_v2_get) | **GET** /api/v1/tiktok/shop/web/fetch_seller_products_list_v2 | 获取商家商品列表V2(移动端)/Get seller products list V2 (Mobile)


# **fetch_hot_selling_products_list_api_v1_tiktok_shop_web_fetch_hot_selling_products_list_get**
> fetch_hot_selling_products_list_api_v1_tiktok_shop_web_fetch_hot_selling_products_list_get(region=region)
...
api_instance = swagger_client.TikTokShopWebAPIApi()
region = NULL # object | 地区代码/Region code (optional)

try:
    # 获取热卖商品列表/Get hot selling products list
    api_instance.fetch_hot_selling_products_list_api_v1_tiktok_shop_web_fetch_hot_selling_products_list_get(region=region)
except ApiException as e:
    print("Exception when calling TikTokShopWebAPIApi->fetch_hot_selling_products_list_api_v1_tiktok_shop_web_fetch_hot_selling_products_list_get: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **region** | [**object**](.md)| 地区代码/Region code | [optional] 
...
seller_id = NULL # object | 卖家ID(可选)/Seller ID (optional) (optional)
region = NULL # object | 地区代码/Region code (optional)

try:
    # 获取商品详情V1(桌面端-数据完整)/Get product detail V1(Full data)
    api_instance.fetch_product_detail_api_v1_tiktok_shop_web_fetch_product_detail_get(product_id, seller_id=seller_id, region=region)
except ApiException as e:
    print("Exception when calling TikTokShopWebAPIApi->fetch_product_detail_api_v1_tiktok_shop_web_fetch_product_detail_get: %s\n" % e)
```
 ...
 **seller_id** | [**object**](.md)| 卖家ID(可选)/Seller ID (optional) | [optional] 
 **region** | [**object**](.md)| 地区代码/Region code | [optional] 
...
# **fetch_product_detail_v2_api_v1_tiktok_shop_web_fetch_product_detail_v2_get**
> fetch_product_detail_v2_api_v1_tiktok_shop_web_fetch_product_detail_v2_get(product_id, seller_id=seller_id, region=region)
...
try:
    # 获取商品详情V2(移动端-数据少)/Get product detail V2 (Less Data)
    api_instance.fetch_product_detail_v2_api_v1_tiktok_shop_web_fetch_product_detail_v2_get(product_id, seller_id=seller_id, region=region)
except ApiException as e:
    print("Exception when calling TikTokShopWebAPIApi->fetch_product_detail_v2_api_v1_tiktok_shop_web_fetch_product_detail_v2_get: %s\n" % e)
```
...
try:
    # 获取商品详情V3(移动端-数据完整)/Get product detail V3 (Full Data)
    api_instance.fetch_product_detail_v3_api_v1_tiktok_shop_web_fetch_product_detail_v3_get(product_id, region=region)
except ApiException as e:
    print("Exception when calling TikTokShopWebAPIApi->fetch_product_detail_v3_api_v1_tiktok_shop_web_fetch_product_detail_v3_get: %s\n" % e)
```
...
# **fetch_product_reviews_v1_api_v1_tiktok_shop_web_fetch_product_reviews_v1_get**
> fetch_product_reviews_v1_api_v1_tiktok_shop_web_fetch_product_reviews_v1_get(product_id, sort_type=sort_type, filter_id=filter_id, offset=offset)
...
api_instance = swagger_client.TikTokShopWebAPIApi()
product_id = NULL # object | 商品ID/Product ID
sort_type = NULL # object | 排序方式/Sort type: 1=相关性/Relevance, 2=最新/Recent (optional)
filter_id = NULL # object | 筛选ID/Filter ID (optional)
offset = NULL # object | 分页偏移量/Offset for pagination (optional)

try:
    # 获取商品评论V1/Get product reviews V1
    api_instance.fetch_product_reviews_v1_api_v1_tiktok_shop_web_fetch_product_reviews_v1_get(product_id, sort_type=sort_type, filter_id=filter_id, offset=offset)
except ApiException as e:
    print("Exception when calling TikTokShopWebAPIApi->fetch_product_reviews_v1_api_v1_tiktok_shop_web_fetch_product_reviews_v1_get: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **product_id** | [**object**](.md)| 商品ID/Product ID | 
 **sort_type** | [**object**](.md)| 排序方式/Sort type: 1&#x3D;相关性/Relevance, 2&#x3D;最新/Recent | [optional] 
 **filter_id** | [**object**](.md)| 筛选ID/Filter ID | [optional] 
 **offset** | [**object**](.md)| 分页偏移量/Offset for pagination | [optional] 
...
api_instance = swagger_client.TikTokShopWebAPIApi()
product_id = NULL # object | 商品ID/Product ID
page_start = NULL # object | 起始页码/Page start (optional)
sort_rule = NULL # object | 排序规则/Sort rule (optional)
filter_type = NULL # object | 筛选类型/Filter type: 1=默认, 2=有图片/视频, 3=真实购买 (optional)
filter_value = NULL # object | 星级筛选/Star filter: 6=全部, 5-1=对应星级 (optional)
region = NULL # object | 地区代码/Region code (optional)

try:
    # 获取商品评论V2/Get product reviews V2
    api_instance.fetch_product_reviews_v2_api_v1_tiktok_shop_web_fetch_product_reviews_v2_get(product_id, page_start=page_start, sort_rule=sort_rule, filter_type=filter_type, filter_value=filter_value, region=region)
except ApiException as e:
    print("Exception when calling TikTokShopWebAPIApi->fetch_product_reviews_v2_api_v1_tiktok_shop_web_fetch_product_reviews_v2_get: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **product_id** | [**object**](.md)| 商品ID/Product ID | 
 **page_start** | [**object**](.md)| 起始页码/Page start | [optional] 
 **sort_rule** | [**object**](.md)| 排序规则/Sort rule | [optional] 
 **filter_type** | [**object**](.md)| 筛选类型/Filter type: 1&#x3D;默认, 2&#x3D;有图片/视频, 3&#x3D;真实购买 | [optional] 
 **filter_value** | [**object**](.md)| 星级筛选/Star filter: 6&#x3D;全部, 5-1&#x3D;对应星级 | [optional] 
 **region** | [**object**](.md)| 地区代码/Region code | [optional] 
...
offset = NULL # object | 翻页偏移量/Offset for pagination (optional)
region = NULL # object | 地区代码/Region code (optional)

try:
    # 根据分类ID获取商品列表/Get products by category ID
    api_instance.fetch_products_by_category_id_api_v1_tiktok_shop_web_fetch_products_by_category_id_get(category_id, offset=offset, region=region)
except ApiException as e:
    print("Exception when calling TikTokShopWebAPIApi->fetch_products_by_category_id_api_v1_tiktok_shop_web_fetch_products_by_category_id_get: %s\n" % e)
```
 ...
 **offset** | [**object**](.md)| 翻页偏移量/Offset for pagination | [optional] 
 **region** | [**object**](.md)| 地区代码/Region code | [optional] 
...
# **fetch_products_category_list_api_v1_tiktok_shop_web_fetch_products_category_list_get**
> fetch_products_category_list_api_v1_tiktok_shop_web_fetch_products_category_list_get(region=region)
...
try:
    # 获取商品分类列表/Get product category list
    api_instance.fetch_products_category_list_api_v1_tiktok_shop_web_fetch_products_category_list_get(region=region)
except ApiException as e:
    print("Exception when calling TikTokShopWebAPIApi->fetch_products_category_list_api_v1_tiktok_shop_web_fetch_products_category_list_get: %s\n" % e)
```
...
# create an instance of the API class
api_instance = swagger_client.TikTokShopWebAPIApi()
search_word = NULL # object | 搜索关键词/Search keyword
...
try:
    # 搜索商品列表V1/Search products list V1
    api_instance.fetch_search_products_list_api_v1_tiktok_shop_web_fetch_search_products_list_get(search_word, offset=offset, page_token=page_token, region=region)
except ApiException as e:
    print("Exception when calling TikTokShopWebAPIApi->fetch_search_products_list_api_v1_tiktok_shop_web_fetch_search_products_list_get: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **search_word** | [**object**](.md)| 搜索关键词/Search keyword | 
...
# **fetch_search_products_list_v2_api_v1_tiktok_shop_web_fetch_search_products_list_v2_get**
> fetch_search_products_list_v2_api_v1_tiktok_shop_web_fetch_search_products_list_v2_get(search_word, offset=offset, page_token=page_token, region=region)
...
try:
    # 搜索商品列表V2(移动端)/Search products list V2 (Mobile)
    api_instance.fetch_search_products_list_v2_api_v1_tiktok_shop_web_fetch_search_products_list_v2_get(search_word, offset=offset, page_token=page_token, region=region)
except ApiException as e:
    print("Exception when calling TikTokShopWebAPIApi->fetch_search_products_list_v2_api_v1_tiktok_shop_web_fetch_search_products_list_v2_get: %s\n" % e)
```
...
> fetch_search_products_list_v3_api_v1_tiktok_shop_web_fetch_search_products_list_v3_get(keyword, offset=offset, region=region, sort_by=sort_by, filters_data=filters_data)
...
offset = NULL # object | 偏移量/Offset (optional)
region = NULL # object | 地区代码/Region code (Alpha-2) (optional)
sort_by = NULL # object | 排序方式/Sort by: RELEVANCE, PRICE_ASC, PRICE_DESC, BEST_SELLERS (optional)
filters_data = NULL # object | 筛选数据JSON/Filters data JSON (optional)

try:
    # 搜索商品列表V3/Search products list V3
    api_instance.fetch_search_products_list_v3_api_v1_tiktok_shop_web_fetch_search_products_list_v3_get(keyword, offset=offset, region=region, sort_by=sort_by, filters_data=filters_data)
except ApiException as e:
    print("Exception when calling TikTokShopWebAPIApi->fetch_search_products_list_v3_api_v1_tiktok_shop_web_fetch_search_products_list_v3_get: %s\n" % e)
```
 ...
 **offset** | [**object**](.md)| 偏移量/Offset | [optional] 
 **region** | [**object**](.md)| 地区代码/Region code (Alpha-2) | [optional] 
 **sort_by** | [**object**](.md)| 排序方式/Sort by: RELEVANCE, PRICE_ASC, PRICE_DESC, BEST_SELLERS | [optional] 
 **filters_data** | [**object**](.md)| 筛选数据JSON/Filters data JSON | [optional] 
...
> fetch_search_word_suggestion_api_v1_tiktok_shop_web_fetch_search_word_suggestion_get(search_word, lang=lang, region=region)
...
api_instance = swagger_client.TikTokShopWebAPIApi()
search_word = NULL # object | 搜索关键词/Search keyword
lang = NULL # object | 语言/Language (optional)
region = NULL # object | 地区代码/Region code (optional)

try:
    # 获取搜索关键词建议V1/Get search keyword suggestions V1
    api_instance.fetch_search_word_suggestion_api_v1_tiktok_shop_web_fetch_search_word_suggestion_get(search_word, lang=lang, region=region)
except ApiException as e:
    print("Exception when calling TikTokShopWebAPIApi->fetch_search_word_suggestion_api_v1_tiktok_shop_web_fetch_search_word_suggestion_get: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **search_word** | [**object**](.md)| 搜索关键词/Search keyword | 
 **lang** | [**object**](.md)| 语言/Language | [optional] 
 **region** | [**object**](.md)| 地区代码/Region code | [optional] 
...
> fetch_search_word_suggestion_v2_api_v1_tiktok_shop_web_fetch_search_word_suggestion_v2_get(search_word, lang=lang, region=region)
...
try:
    # 获取搜索关键词建议V2(移动端)/Get search keyword suggestions V2 (Mobile)
    api_instance.fetch_search_word_suggestion_v2_api_v1_tiktok_shop_web_fetch_search_word_suggestion_v2_get(search_word, lang=lang, region=region)
except ApiException as e:
    print("Exception when calling TikTokShopWebAPIApi->fetch_search_word_suggestion_v2_api_v1_tiktok_shop_web_fetch_search_word_suggestion_v2_get: %s\n" % e)
```
...
# create an instance of the API class
api_instance = swagger_client.TikTokShopWebAPIApi()
seller_id = NULL # object | 卖家ID/Seller ID
search_params = NULL # object | 搜索参数(用于分页)/Search params (for pagination) (optional)
region = NULL # object | 地区代码/Region code (optional)

try:
    # 获取商家商品列表V1/Get seller products list V1
    api_instance.fetch_seller_products_list_api_v1_tiktok_shop_web_fetch_seller_products_list_get(seller_id, search_params=search_params, region=region)
except ApiException as e:
    print("Exception when calling TikTokShopWebAPIApi->fetch_seller_products_list_api_v1_tiktok_shop_web_fetch_seller_products_list_get: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **seller_id** | [**object**](.md)| 卖家ID/Seller ID | 
 **search_params** | [**object**](.md)| 搜索参数(用于分页)/Search params (for pagination) | [optional] 
 **region** | [**object**](.md)| 地区代码/Region code | [optional] 
...
> fetch_seller_products_list_v2_api_v1_tiktok_shop_web_fetch_seller_products_list_v2_get(seller_id, search_params=search_params, region=region)
...
api_instance = swagger_client.TikTokShopWebAPIApi()
seller_id = NULL # object | 卖家ID/Seller ID
search_params = NULL # object | 搜索参数/Search params (optional)
region = NULL # object | 地区代码/Region code (optional)

try:
    # 获取商家商品列表V2(移动端)/Get seller products list V2 (Mobile)
    api_instance.fetch_seller_products_list_v2_api_v1_tiktok_shop_web_fetch_seller_products_list_v2_get(seller_id, search_params=search_params, region=region)
except ApiException as e:
    print("Exception when calling TikTokShopWebAPIApi->fetch_seller_products_list_v2_api_v1_tiktok_shop_web_fetch_seller_products_list_v2_get: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **seller_id** | [**object**](.md)| 卖家ID/Seller ID | 
 **search_params** | [**object**](.md)| 搜索参数/Search params | [optional] 
 **region** | [**object**](.md)| 地区代码/Region code | [optional] 

# swagger_client.YouTubeWebAPIApi

All URIs are relative to *https://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**api_get_video_subtitles_api_v1_youtube_web_get_video_subtitles_get**](YouTubeWebAPIApi.md#api_get_video_subtitles_api_v1_youtube_web_get_video_subtitles_get) | **GET** /api/v1/youtube/web/get_video_subtitles | 获取视频字幕/Get video subtitles
[**get_channel_description_api_v1_youtube_web_get_channel_description_get**](YouTubeWebAPIApi.md#get_channel_description_api_v1_youtube_web_get_channel_description_get) | **GET** /api/v1/youtube/web/get_channel_description | 获取频道描述信息/Get channel description
...
[**get_channel_id_v2_api_v1_youtube_web_get_channel_id_v2_get**](YouTubeWebAPIApi.md#get_channel_id_v2_api_v1_youtube_web_get_channel_id_v2_get) | **GET** /api/v1/youtube/web/get_channel_id_v2 | 从频道URL获取频道ID V2/Get channel ID from URL V2
...
[**get_channel_url_api_v1_youtube_web_get_channel_url_get**](YouTubeWebAPIApi.md#get_channel_url_api_v1_youtube_web_get_channel_url_get) | **GET** /api/v1/youtube/web/get_channel_url | 从频道ID获取频道URL/Get channel URL from channel ID
[**get_channel_videos_api_v1_youtube_web_get_channel_videos_get**](YouTubeWebAPIApi.md#get_channel_videos_api_v1_youtube_web_get_channel_videos_get) | **GET** /api/v1/youtube/web/get_channel_videos | 获取频道视频 V1（即将过时，优先使用 V2）/Get channel videos V1 (deprecated soon, use V2 first)
[**get_channel_videos_v2_api_v1_youtube_web_get_channel_videos_v2_get**](YouTubeWebAPIApi.md#get_channel_videos_v2_api_v1_youtube_web_get_channel_videos_v2_get) | **GET** /api/v1/youtube/web/get_channel_videos_v2 | 获取频道视频 V2/Get channel videos V2
[**get_channel_videos_v3_api_v1_youtube_web_get_channel_videos_v3_get**](YouTubeWebAPIApi.md#get_channel_videos_v3_api_v1_youtube_web_get_channel_videos_v3_get) | **GET** /api/v1/youtube/web/get_channel_videos_v3 | 获取频道视频 V3/Get channel videos V3
[**get_general_search_api_v1_youtube_web_get_general_search_get**](YouTubeWebAPIApi.md#get_general_search_api_v1_youtube_web_get_general_search_get) | **GET** /api/v1/youtube/web/get_general_search | 综合搜索（支持过滤条件）/General search with filters
...
[**get_shorts_search_api_v1_youtube_web_get_shorts_search_get**](YouTubeWebAPIApi.md#get_shorts_search_api_v1_youtube_web_get_shorts_search_get) | **GET** /api/v1/youtube/web/get_shorts_search | YouTube Shorts短视频搜索/YouTube Shorts search
...
[**get_video_comment_replies_api_v1_youtube_web_get_video_comment_replies_get**](YouTubeWebAPIApi.md#get_video_comment_replies_api_v1_youtube_web_get_video_comment_replies_get) | **GET** /api/v1/youtube/web/get_video_comment_replies | 获取视频二级评论/Get video sub comments
...
[**get_video_info_api_v1_youtube_web_get_video_info_get**](YouTubeWebAPIApi.md#get_video_info_api_v1_youtube_web_get_video_info_get) | **GET** /api/v1/youtube/web/get_video_info | 获取视频信息 V1/Get video information V1
[**get_video_info_v2_api_v1_youtube_web_get_video_info_v2_get**](YouTubeWebAPIApi.md#get_video_info_v2_api_v1_youtube_web_get_video_info_v2_get) | **GET** /api/v1/youtube/web/get_video_info_v2 | 获取视频信息 V2/Get video information V2
[**get_video_info_v3_api_v1_youtube_web_get_video_info_v3_get**](YouTubeWebAPIApi.md#get_video_info_v3_api_v1_youtube_web_get_video_info_v3_get) | **GET** /api/v1/youtube/web/get_video_info_v3 | 获取视频详情 V3/Get video information V3
...
> api_get_video_subtitles_api_v1_youtube_web_get_video_subtitles_get(subtitle_url, format=format, fix_overlap=fix_overlap, target_lang=target_lang)
...
api_instance = swagger_client.YouTubeWebAPIApi()
subtitle_url = NULL # object | 字幕URL（需先调用获取视频详情接口） / Subtitle URL from video details
format = NULL # object | 字幕格式：srt/xml/vtt/txt / Subtitle format (optional)
fix_overlap = NULL # object | 修复重叠字幕（默认开启） / Fix overlapping subtitles (optional)
target_lang = NULL # object | 目标语言代码（留空保持原语言） / Target language code (optional)

try:
    # 获取视频字幕/Get video subtitles
    api_instance.api_get_video_subtitles_api_v1_youtube_web_get_video_subtitles_get(subtitle_url, format=format, fix_overlap=fix_overlap, target_lang=target_lang)
except ApiException as e:
    print("Exception when calling YouTubeWebAPIApi->api_get_video_subtitles_api_v1_youtube_web_get_video_subtitles_get: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **subtitle_url** | [**object**](.md)| 字幕URL（需先调用获取视频详情接口） / Subtitle URL from video details | 
 **format** | [**object**](.md)| 字幕格式：srt/xml/vtt/txt / Subtitle format | [optional] 
 **fix_overlap** | [**object**](.md)| 修复重叠字幕（默认开启） / Fix overlapping subtitles | [optional] 
 **target_lang** | [**object**](.md)| 目标语言代码（留空保持原语言） / Target language code | [optional] 
...
# **get_channel_description_api_v1_youtube_web_get_channel_description_get**
> get_channel_description_api_v1_youtube_web_get_channel_description_get(channel_id=channel_id, continuation_token=continuation_token, language_code=language_code, country_code=country_code, need_format=need_format)
...
# create an instance of the API class
api_instance = swagger_client.YouTubeWebAPIApi()
channel_id = NULL # object | 频道ID（格式如：UCeu6U67OzJhV1KwBansH3Dg），可通过get_channel_id_v2接口从频道URL获取/Channel ID, can be obtained from channel URL via get_channel_id_v2 endpoint (optional)
...
try:
    # 获取频道描述信息/Get channel description
    api_instance.get_channel_description_api_v1_youtube_web_get_channel_description_get(channel_id=channel_id, continuation_token=continuation_token, language_code=language_code, country_code=country_code, need_format=need_format)
except ApiException as e:
    print("Exception when calling YouTubeWebAPIApi->get_channel_description_api_v1_youtube_web_get_channel_description_get: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **channel_id** | [**object**](.md)| 频道ID（格式如：UCeu6U67OzJhV1KwBansH3Dg），可通过get_channel_id_v2接口从频道URL获取/Channel ID, can be obtained from channel URL via get_channel_id_v2 endpoint | [optional] 
...
> get_channel_id_api_v1_youtube_web_get_channel_id_get(channel_name)
...
# create an instance of the API class
api_instance = swagger_client.YouTubeWebAPIApi()
channel_name = NULL # object | 频道名称/Channel name

try:
    # 获取频道ID/Get channel ID
    api_instance.get_channel_id_api_v1_youtube_web_get_channel_id_get(channel_name)
except ApiException as e:
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **channel_name** | [**object**](.md)| 频道名称/Channel name | 
...
# **get_channel_id_v2_api_v1_youtube_web_get_channel_id_v2_get**
> get_channel_id_v2_api_v1_youtube_web_get_channel_id_v2_get(channel_url)
...
try:
    # 从频道URL获取频道ID V2/Get channel ID from URL V2
    api_instance.get_channel_id_v2_api_v1_youtube_web_get_channel_id_v2_get(channel_url)
except ApiException as e:
    print("Exception when calling YouTubeWebAPIApi->get_channel_id_v2_api_v1_youtube_web_get_channel_id_v2_get: %s\n" % e)
```
...
> get_channel_info_api_v1_youtube_web_get_channel_info_get(channel_id)
...
try:
    # 获取频道信息/Get channel information
    api_instance.get_channel_info_api_v1_youtube_web_get_channel_info_get(channel_id)
except ApiException as e:
...
> get_channel_short_videos_api_v1_youtube_web_get_channel_short_videos_get(channel_id, continuation_token=continuation_token)
...
try:
    # 获取频道短视频/Get channel short videos
    api_instance.get_channel_short_videos_api_v1_youtube_web_get_channel_short_videos_get(channel_id, continuation_token=continuation_token)
except ApiException as e:
...
> get_channel_url_api_v1_youtube_web_get_channel_url_get(channel_id)
...
try:
    # 从频道ID获取频道URL/Get channel URL from channel ID
    api_instance.get_channel_url_api_v1_youtube_web_get_channel_url_get(channel_id)
except ApiException as e:
    print("Exception when calling YouTubeWebAPIApi->get_channel_url_api_v1_youtube_web_get_channel_url_get: %s\n" % e)
```
...
> get_channel_videos_api_v1_youtube_web_get_channel_videos_get(channel_id, continuation_token=continuation_token)
...
try:
    # 获取频道视频 V1（即将过时，优先使用 V2）/Get channel videos V1 (deprecated soon, use V2 first)
    api_instance.get_channel_videos_api_v1_youtube_web_get_channel_videos_get(channel_id, continuation_token=continuation_token)
except ApiException as e:
...
api_instance = swagger_client.YouTubeWebAPIApi()
channel_id = NULL # object | 频道ID/Channel ID
lang = NULL # object | 视频结果语言代码/Video result language code (optional)
sort_by = NULL # object | 排序方式/Sort by (optional)
content_type = NULL # object | 内容类型/Content type (optional)
next_token = NULL # object | 翻页令牌/Pagination token (optional)

try:
    # 获取频道视频 V2/Get channel videos V2
    api_instance.get_channel_videos_v2_api_v1_youtube_web_get_channel_videos_v2_get(channel_id, lang=lang, sort_by=sort_by, content_type=content_type, next_token=next_token)
except ApiException as e:
    print("Exception when calling YouTubeWebAPIApi->get_channel_videos_v2_api_v1_youtube_web_get_channel_videos_v2_get: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **channel_id** | [**object**](.md)| 频道ID/Channel ID | 
 **lang** | [**object**](.md)| 视频结果语言代码/Video result language code | [optional] 
 **sort_by** | [**object**](.md)| 排序方式/Sort by | [optional] 
 **content_type** | [**object**](.md)| 内容类型/Content type | [optional] 
 **next_token** | [**object**](.md)| 翻页令牌/Pagination token | [optional] 
...
try:
    # 获取频道视频 V3/Get channel videos V3
    api_instance.get_channel_videos_v3_api_v1_youtube_web_get_channel_videos_v3_get(channel_id, language_code=language_code, country_code=country_code, continuation_token=continuation_token, need_format=need_format)
except ApiException as e:
    print("Exception when calling YouTubeWebAPIApi->get_channel_videos_v3_api_v1_youtube_web_get_channel_videos_v3_get: %s\n" % e)
```
...
# **get_general_search_api_v1_youtube_web_get_general_search_get**
> get_general_search_api_v1_youtube_web_get_general_search_get(search_query, language_code=language_code, country_code=country_code, time_zone=time_zone, upload_time=upload_time, duration=duration, content_type=content_type, feature=feature, sort_by=sort_by, continuation_token=continuation_token)
...
try:
    # 综合搜索（支持过滤条件）/General search with filters
    api_instance.get_general_search_api_v1_youtube_web_get_general_search_get(search_query, language_code=language_code, country_code=country_code, time_zone=time_zone, upload_time=upload_time, duration=duration, content_type=content_type, feature=feature, sort_by=sort_by, continuation_token=continuation_token)
except ApiException as e:
    print("Exception when calling YouTubeWebAPIApi->get_general_search_api_v1_youtube_web_get_general_search_get: %s\n" % e)
```
...
> get_relate_video_api_v1_youtube_web_get_relate_video_get(video_id, continuation_token=continuation_token)
...
try:
    # 获取推荐视频/Get related videos
    api_instance.get_relate_video_api_v1_youtube_web_get_relate_video_get(video_id, continuation_token=continuation_token)
except ApiException as e:
...
# **get_shorts_search_api_v1_youtube_web_get_shorts_search_get**
> get_shorts_search_api_v1_youtube_web_get_shorts_search_get(search_query, language_code=language_code, country_code=country_code, time_zone=time_zone, upload_time=upload_time, sort_by=sort_by, continuation_token=continuation_token, filter_mixed_content=filter_mixed_content)
...
try:
    # YouTube Shorts短视频搜索/YouTube Shorts search
    api_instance.get_shorts_search_api_v1_youtube_web_get_shorts_search_get(search_query, language_code=language_code, country_code=country_code, time_zone=time_zone, upload_time=upload_time, sort_by=sort_by, continuation_token=continuation_token, filter_mixed_content=filter_mixed_content)
except ApiException as e:
    print("Exception when calling YouTubeWebAPIApi->get_shorts_search_api_v1_youtube_web_get_shorts_search_get: %s\n" % e)
```
...
> get_trending_videos_api_v1_youtube_web_get_trending_videos_get(language_code=language_code, country_code=country_code, section=section)
...
# create an instance of the API class
api_instance = swagger_client.YouTubeWebAPIApi()
language_code = NULL # object | 语言代码/Language code (optional)
country_code = NULL # object | 国家代码/Country code (optional)
section = NULL # object | 类型/Section (optional)

try:
    # 获取趋势视频/Get trending videos
    api_instance.get_trending_videos_api_v1_youtube_web_get_trending_videos_get(language_code=language_code, country_code=country_code, section=section)
except ApiException as e:
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **language_code** | [**object**](.md)| 语言代码/Language code | [optional] 
 **country_code** | [**object**](.md)| 国家代码/Country code | [optional] 
 **section** | [**object**](.md)| 类型/Section | [optional] 
...
# **get_video_comment_replies_api_v1_youtube_web_get_video_comment_replies_get**
> get_video_comment_replies_api_v1_youtube_web_get_video_comment_replies_get(continuation_token, language_code=language_code, country_code=country_code, need_format=need_format)
...
try:
    # 获取视频二级评论/Get video sub comments
    api_instance.get_video_comment_replies_api_v1_youtube_web_get_video_comment_replies_get(continuation_token, language_code=language_code, country_code=country_code, need_format=need_format)
except ApiException as e:
    print("Exception when calling YouTubeWebAPIApi->get_video_comment_replies_api_v1_youtube_web_get_video_comment_replies_get: %s\n" % e)
```
...
> get_video_comments_api_v1_youtube_web_get_video_comments_get(video_id, language_code=language_code, country_code=country_code, sort_by=sort_by, continuation_token=continuation_token, need_format=need_format)
...
try:
    # 获取视频评论/Get video comments
    api_instance.get_video_comments_api_v1_youtube_web_get_video_comments_get(video_id, language_code=language_code, country_code=country_code, sort_by=sort_by, continuation_token=continuation_token, need_format=need_format)
except ApiException as e:
...
api_instance = swagger_client.YouTubeWebAPIApi()
video_id = NULL # object | 视频ID/Video ID
url_access = NULL # object | URL访问模式：normal（包含音视频URL）| blocked（不包含音视频URL） / URL access mode (optional)
lang = NULL # object | 语言代码（IETF标签），默认en-US / Language code (optional)
videos = NULL # object | 视频格式：auto（自动）| true（简化格式）| raw（原始格式）| false（不获取） / Video format selection (optional)
audios = NULL # object | 音频格式：auto（自动）| true（简化格式）| raw（原始格式）| false（不获取） / Audio format selection (optional)
subtitles = NULL # object | 是否获取字幕 / Include subtitles (optional)
related = NULL # object | 是否获取相关视频 / Include related content (optional)

try:
    # 获取视频信息 V1/Get video information V1
    api_instance.get_video_info_api_v1_youtube_web_get_video_info_get(video_id, url_access=url_access, lang=lang, videos=videos, audios=audios, subtitles=subtitles, related=related)
except ApiException as e:
...
------------- | ------------- | ------------- | -------------
 **video_id** | [**object**](.md)| 视频ID/Video ID | 
 **url_access** | [**object**](.md)| URL访问模式：normal（包含音视频URL）| blocked（不包含音视频URL） / URL access mode | [optional] 
 **lang** | [**object**](.md)| 语言代码（IETF标签），默认en-US / Language code | [optional] 
 **videos** | [**object**](.md)| 视频格式：auto（自动）| true（简化格式）| raw（原始格式）| false（不获取） / Video format selection | [optional] 
 **audios** | [**object**](.md)| 音频格式：auto（自动）| true（简化格式）| raw（原始格式）| false（不获取） / Audio format selection | [optional] 
 **subtitles** | [**object**](.md)| 是否获取字幕 / Include subtitles | [optional] 
 **related** | [**object**](.md)| 是否获取相关视频 / Include related content | [optional] 
...
try:
    # 获取视频信息 V2/Get video information V2
    api_instance.get_video_info_v2_api_v1_youtube_web_get_video_info_v2_get(video_id)
except ApiException as e:
    print("Exception when calling YouTubeWebAPIApi->get_video_info_v2_api_v1_youtube_web_get_video_info_v2_get: %s\n" % e)
```
...
# **get_video_info_v3_api_v1_youtube_web_get_video_info_v3_get**
> get_video_info_v3_api_v1_youtube_web_get_video_info_v3_get(video_id, language_code=language_code)
...
try:
    # 获取视频详情 V3/Get video information V3
    api_instance.get_video_info_v3_api_v1_youtube_web_get_video_info_v3_get(video_id, language_code=language_code)
except ApiException as e:
    print("Exception when calling YouTubeWebAPIApi->get_video_info_v3_api_v1_youtube_web_get_video_info_v3_get: %s\n" % e)
```
...
> search_channel_api_v1_youtube_web_search_channel_get(channel_id, search_query, language_code=language_code, country_code=country_code, continuation_token=continuation_token)
...
try:
    # 搜索频道/Search channel
    api_instance.search_channel_api_v1_youtube_web_search_channel_get(channel_id, search_query, language_code=language_code, country_code=country_code, continuation_token=continuation_token)
except ApiException as e:
...
> search_video_api_v1_youtube_web_search_video_get(search_query, language_code=language_code, order_by=order_by, country_code=country_code, continuation_token=continuation_token)

搜索视频/Search video

# [中文] ### 用途: - 搜索视频。 ### 参数: - search_query: 搜索关键字。 - language_code: 语言代码，默认为en。 - order_by: 排序方式，默认为this_month，可选值为this_week, this_month, this_year, last_hour, today。 - country_code: 国家代码，默认为us。 - continuation_token: 用于继续获取搜索结果的令牌。默认为None。 ### 返回: - 搜索结果。  # [English] ### Purpose: - Search video. ### Parameters: - search_query: Search keyword. - language_code: Language code, default is en. - order_by: Order by, default is this_month, optional values are this_week, this_month, this_year, last_hour, today. - country_code: Country code, default is us. - continuation_token: Token to continue fetching search results. Default is None. ### Returns: - Search results.  # [示例/Example] search_query = \"Minecraft\"
...
search_query = NULL # object | 搜索关键字/Search keyword
language_code = NULL # object | 语言代码/Language code (optional)
order_by = NULL # object | 排序方式/Order by (optional)
country_code = NULL # object | 国家代码/Country code (optional)
continuation_token = NULL # object | 翻页令牌/Pagination token (optional)

try:
    # 搜索视频/Search video
    api_instance.search_video_api_v1_youtube_web_search_video_get(search_query, language_code=language_code, order_by=order_by, country_code=country_code, continuation_token=continuation_token)
except ApiException as e:
 ...
 **search_query** | [**object**](.md)| 搜索关键字/Search keyword | 
 **language_code** | [**object**](.md)| 语言代码/Language code | [optional] 
 **order_by** | [**object**](.md)| 排序方式/Order by | [optional] 
 **country_code** | [**object**](.md)| 国家代码/Country code | [optional] 
 **continuation_token** | [**object**](.md)| 翻页令牌/Pagination token | [optional] 

# swagger_client.TikHubUserAPIApi
...
> calculate_price_api_v1_tikhub_user_calculate_price_get(endpoint, request_per_day=request_per_day)
...
api_instance = swagger_client.TikHubUserAPIApi()
endpoint = NULL # object | 请求的端点/Requested endpoint
request_per_day = NULL # object | 每日请求次数/Request per day (optional)

try:
    # 计算价格/Calculate price
    api_instance.calculate_price_api_v1_tikhub_user_calculate_price_get(endpoint, request_per_day=request_per_day)
...
------------- | ------------- | ------------- | -------------
 **endpoint** | [**object**](.md)| 请求的端点/Requested endpoint | 
 **request_per_day** | [**object**](.md)| 每日请求次数/Request per day | [optional] 
...
try:
    # 获取所有端点信息/Get all endpoints information
    api_instance.get_all_endpoints_info_api_v1_tikhub_user_get_all_endpoints_info_get()
except ApiException as e:
...
> get_endpoint_info_api_v1_tikhub_user_get_endpoint_info_get(endpoint)
...
try:
    # 获取一个端点的信息/Get information of an endpoint
    api_instance.get_endpoint_info_api_v1_tikhub_user_get_endpoint_info_get(endpoint)
except ApiException as e:
...
try:
    # 获取阶梯式折扣百分比信息/Get tiered discount percentage information
    api_instance.get_tiered_discount_info_api_v1_tikhub_user_get_tiered_discount_info_get()
except ApiException as e:
...
try:
    # 获取用户每日使用情况/Get user daily usage
    api_instance.get_user_daily_usage_api_v1_tikhub_user_get_user_daily_usage_get()
except ApiException as e:
...
try:
    # 获取TikHub用户信息/Get TikHub user info
    api_instance.get_user_info_api_v1_tikhub_user_get_user_info_get()
except ApiException as e:

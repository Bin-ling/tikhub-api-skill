# swagger_client.InstagramV3APIApi

All URIs are relative to *https://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**bulk_translate_comments_api_v1_instagram_v3_bulk_translate_comments_get**](InstagramV3APIApi.md#bulk_translate_comments_api_v1_instagram_v3_bulk_translate_comments_get) | **GET** /api/v1/instagram/v3/bulk_translate_comments | 批量翻译评论/Bulk translate comments
[**general_search_api_v1_instagram_v3_general_search_get**](InstagramV3APIApi.md#general_search_api_v1_instagram_v3_general_search_get) | **GET** /api/v1/instagram/v3/general_search | 综合搜索（支持分页）/General search (with pagination)
[**get_comment_replies_api_v1_instagram_v3_get_comment_replies_get**](InstagramV3APIApi.md#get_comment_replies_api_v1_instagram_v3_get_comment_replies_get) | **GET** /api/v1/instagram/v3/get_comment_replies | 获取评论的子评论/回复/Get comment replies
[**get_explore_api_v1_instagram_v3_get_explore_get**](InstagramV3APIApi.md#get_explore_api_v1_instagram_v3_get_explore_get) | **GET** /api/v1/instagram/v3/get_explore | 获取探索页推荐帖子/Get explore feed
[**get_highlight_stories_api_v1_instagram_v3_get_highlight_stories_get**](InstagramV3APIApi.md#get_highlight_stories_api_v1_instagram_v3_get_highlight_stories_get) | **GET** /api/v1/instagram/v3/get_highlight_stories | 获取Highlight精选详情/Get highlight stories
[**get_location_info_api_v1_instagram_v3_get_location_info_get**](InstagramV3APIApi.md#get_location_info_api_v1_instagram_v3_get_location_info_get) | **GET** /api/v1/instagram/v3/get_location_info | 获取地点详情/Get location info
[**get_location_posts_api_v1_instagram_v3_get_location_posts_get**](InstagramV3APIApi.md#get_location_posts_api_v1_instagram_v3_get_location_posts_get) | **GET** /api/v1/instagram/v3/get_location_posts | 获取地点相关帖子/Get location posts
[**get_post_comments_api_v1_instagram_v3_get_post_comments_get**](InstagramV3APIApi.md#get_post_comments_api_v1_instagram_v3_get_post_comments_get) | **GET** /api/v1/instagram/v3/get_post_comments | 获取帖子评论/Get post comments
[**get_post_info_api_v1_instagram_v3_get_post_info_get**](InstagramV3APIApi.md#get_post_info_api_v1_instagram_v3_get_post_info_get) | **GET** /api/v1/instagram/v3/get_post_info | 获取帖子详情/Get post info (media_id or URL)
[**get_post_info_by_code_api_v1_instagram_v3_get_post_info_by_code_get**](InstagramV3APIApi.md#get_post_info_by_code_api_v1_instagram_v3_get_post_info_by_code_get) | **GET** /api/v1/instagram/v3/get_post_info_by_code | 获取帖子详情(code)/Get post info by shortcode
[**get_post_oembed_api_v1_instagram_v3_get_post_oembed_get**](InstagramV3APIApi.md#get_post_oembed_api_v1_instagram_v3_get_post_oembed_get) | **GET** /api/v1/instagram/v3/get_post_oembed | 获取帖子oEmbed内嵌信息/Get post oEmbed info
[**get_recommended_reels_api_v1_instagram_v3_get_recommended_reels_get**](InstagramV3APIApi.md#get_recommended_reels_api_v1_instagram_v3_get_recommended_reels_get) | **GET** /api/v1/instagram/v3/get_recommended_reels | 获取Reels推荐列表/Get recommended Reels feed
[**get_user_about_api_v1_instagram_v3_get_user_about_get**](InstagramV3APIApi.md#get_user_about_api_v1_instagram_v3_get_user_about_get) | **GET** /api/v1/instagram/v3/get_user_about | 获取用户账户简介/Get user about info
[**get_user_brief_api_v1_instagram_v3_get_user_brief_get**](InstagramV3APIApi.md#get_user_brief_api_v1_instagram_v3_get_user_brief_get) | **GET** /api/v1/instagram/v3/get_user_brief | 获取用户短详情/Get user brief info
[**get_user_followers_api_v1_instagram_v3_get_user_followers_get**](InstagramV3APIApi.md#get_user_followers_api_v1_instagram_v3_get_user_followers_get) | **GET** /api/v1/instagram/v3/get_user_followers | 获取用户粉丝列表/Get user followers list
[**get_user_following_api_v1_instagram_v3_get_user_following_get**](InstagramV3APIApi.md#get_user_following_api_v1_instagram_v3_get_user_following_get) | **GET** /api/v1/instagram/v3/get_user_following | 获取用户关注列表/Get user following list
[**get_user_highlights_api_v1_instagram_v3_get_user_highlights_get**](InstagramV3APIApi.md#get_user_highlights_api_v1_instagram_v3_get_user_highlights_get) | **GET** /api/v1/instagram/v3/get_user_highlights | 获取用户精选Highlights列表/Get user highlights
[**get_user_posts_api_v1_instagram_v3_get_user_posts_get**](InstagramV3APIApi.md#get_user_posts_api_v1_instagram_v3_get_user_posts_get) | **GET** /api/v1/instagram/v3/get_user_posts | 获取用户帖子列表/Get user posts
[**get_user_profile_api_v1_instagram_v3_get_user_profile_get**](InstagramV3APIApi.md#get_user_profile_api_v1_instagram_v3_get_user_profile_get) | **GET** /api/v1/instagram/v3/get_user_profile | 获取用户信息/Get user profile
[**get_user_reels_api_v1_instagram_v3_get_user_reels_get**](InstagramV3APIApi.md#get_user_reels_api_v1_instagram_v3_get_user_reels_get) | **GET** /api/v1/instagram/v3/get_user_reels | 获取用户Reels列表/Get user reels
[**get_user_stories_api_v1_instagram_v3_get_user_stories_get**](InstagramV3APIApi.md#get_user_stories_api_v1_instagram_v3_get_user_stories_get) | **GET** /api/v1/instagram/v3/get_user_stories | 获取用户Stories（快拍）/Get user stories
[**get_user_tagged_posts_api_v1_instagram_v3_get_user_tagged_posts_get**](InstagramV3APIApi.md#get_user_tagged_posts_api_v1_instagram_v3_get_user_tagged_posts_get) | **GET** /api/v1/instagram/v3/get_user_tagged_posts | 获取用户被标记的帖子/Get user tagged posts
[**search_hashtags_api_v1_instagram_v3_search_hashtags_get**](InstagramV3APIApi.md#search_hashtags_api_v1_instagram_v3_search_hashtags_get) | **GET** /api/v1/instagram/v3/search_hashtags | 搜索话题标签/Search hashtags
[**search_places_api_v1_instagram_v3_search_places_get**](InstagramV3APIApi.md#search_places_api_v1_instagram_v3_search_places_get) | **GET** /api/v1/instagram/v3/search_places | 搜索地点/Search places
[**search_users_api_v1_instagram_v3_search_users_get**](InstagramV3APIApi.md#search_users_api_v1_instagram_v3_search_users_get) | **GET** /api/v1/instagram/v3/search_users | 搜索用户/Search users
[**translate_comment_api_v1_instagram_v3_translate_comment_get**](InstagramV3APIApi.md#translate_comment_api_v1_instagram_v3_translate_comment_get) | **GET** /api/v1/instagram/v3/translate_comment | 翻译评论/帖子文本/Translate comment or caption


# **bulk_translate_comments_api_v1_instagram_v3_bulk_translate_comments_get**
> bulk_translate_comments_api_v1_instagram_v3_bulk_translate_comments_get(comment_ids)

批量翻译评论/Bulk translate comments

# [中文] ### 用途: - 批量翻译Instagram评论 - 支持同时翻译多条评论，效率更高 - 评论ID可从 get_post_comments 接口获取 ### 参数: - comment_ids: 评论ID列表，多个ID用逗号分隔，**最多10条**     - 例如: `18099342953509681` （单个）     - 例如: `18099342953509681,18099342953509682,18099342953509683` （多个） ### 注意: - 单次请求最多支持10条评论ID，超过会返回错误 ### 返回: - `data.comment_translations`: 翻译结果映射     - key: 评论ID     - value: 翻译后的文本 ### 价格: - 0.002 USD/请求  # [English] ### Purpose: - Bulk translate Instagram comments - Support translating multiple comments at once for better efficiency - Comment IDs can be obtained from get_post_comments API ### Parameters: - comment_ids: Comment ID list, separated by commas, **max 10 IDs**     - Example: `18099342953509681` (single)     - Example: `18099342953509681,18099342953509682,18099342953509683` (multiple) ### Note: - Maximum 10 comment IDs per request, exceeding will return an error ### Return: - `data.comment_translations`: Translation result mapping     - key: Comment ID     - value: Translated text ### Price: - 0.002 USD/request  ### 示例/Example ``` comment_ids = \"18099342953509681\" # comment_ids = \"18099342953509681,18099342953509682\" ```
...
api_instance = swagger_client.InstagramV3APIApi()
comment_ids = NULL # object | 评论ID列表，逗号分隔/Comment ID list, comma separated

try:
    # 批量翻译评论/Bulk translate comments
    api_instance.bulk_translate_comments_api_v1_instagram_v3_bulk_translate_comments_get(comment_ids)
except ApiException as e:
    print("Exception when calling InstagramV3APIApi->bulk_translate_comments_api_v1_instagram_v3_bulk_translate_comments_get: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **comment_ids** | [**object**](.md)| 评论ID列表，逗号分隔/Comment ID list, comma separated | 
...
next_max_id = NULL # object | 分页ID，首次请求不传，从上一次响应的next_max_id获取/Pagination ID, omit for first request, get from previous response next_max_id (optional)
rank_token = NULL # object | 排序token，首次请求不传，从上一次响应获取/Rank token, omit for first request, get from previous response (optional)
enable_metadata = NULL # object | 是否启用元数据/Enable metadata (optional)

try:
    # 综合搜索（支持分页）/General search (with pagination)
    api_instance.general_search_api_v1_instagram_v3_general_search_get(query, next_max_id=next_max_id, rank_token=rank_token, enable_metadata=enable_metadata)
except ApiException as e:
    print("Exception when calling InstagramV3APIApi->general_search_api_v1_instagram_v3_general_search_get: %s\n" % e)
```
 ...
 **next_max_id** | [**object**](.md)| 分页ID，首次请求不传，从上一次响应的next_max_id获取/Pagination ID, omit for first request, get from previous response next_max_id | [optional] 
 **rank_token** | [**object**](.md)| 排序token，首次请求不传，从上一次响应获取/Rank token, omit for first request, get from previous response | [optional] 
 **enable_metadata** | [**object**](.md)| 是否启用元数据/Enable metadata | [optional] 
...
# create an instance of the API class
api_instance = swagger_client.InstagramV3APIApi()
comment_id = NULL # object | 父评论ID/Parent comment ID
media_id = NULL # object | 帖子媒体ID/Post media ID (optional)
code = NULL # object | 帖子短代码/Post shortcode (optional)
url = NULL # object | 帖子URL/Post URL (optional)
min_id = NULL # object | 分页游标，首次请求不传，从上一次响应的 next_min_child_cursor 获取/Pagination cursor, omit for first request, get from previous response next_min_child_cursor (optional)

try:
    # 获取评论的子评论/回复/Get comment replies
    api_instance.get_comment_replies_api_v1_instagram_v3_get_comment_replies_get(comment_id, media_id=media_id, code=code, url=url, min_id=min_id)
except ApiException as e:
    print("Exception when calling InstagramV3APIApi->get_comment_replies_api_v1_instagram_v3_get_comment_replies_get: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **comment_id** | [**object**](.md)| 父评论ID/Parent comment ID | 
 **media_id** | [**object**](.md)| 帖子媒体ID/Post media ID | [optional] 
 **code** | [**object**](.md)| 帖子短代码/Post shortcode | [optional] 
 **url** | [**object**](.md)| 帖子URL/Post URL | [optional] 
 **min_id** | [**object**](.md)| 分页游标，首次请求不传，从上一次响应的 next_min_child_cursor 获取/Pagination cursor, omit for first request, get from previous response next_min_child_cursor | [optional] 
...
# **get_explore_api_v1_instagram_v3_get_explore_get**
> get_explore_api_v1_instagram_v3_get_explore_get(max_id=max_id)
...
# create an instance of the API class
api_instance = swagger_client.InstagramV3APIApi()
max_id = NULL # object | 分页游标，首次请求不传，从上一次响应的 next_max_id 获取/Pagination cursor, omit for first request, get from previous response next_max_id (optional)

try:
    # 获取探索页推荐帖子/Get explore feed
    api_instance.get_explore_api_v1_instagram_v3_get_explore_get(max_id=max_id)
except ApiException as e:
    print("Exception when calling InstagramV3APIApi->get_explore_api_v1_instagram_v3_get_explore_get: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **max_id** | [**object**](.md)| 分页游标，首次请求不传，从上一次响应的 next_max_id 获取/Pagination cursor, omit for first request, get from previous response next_max_id | [optional] 
...
# create an instance of the API class
api_instance = swagger_client.InstagramV3APIApi()
highlight_id = NULL # object | 精选ID/Highlight ID (格式/format: highlight:xxx)
reel_ids = NULL # object | 精选ID列表，逗号分隔，如不提供则仅查询highlight_id/Highlight ID list, comma separated, if not provided only query highlight_id (optional)

try:
    # 获取Highlight精选详情/Get highlight stories
    api_instance.get_highlight_stories_api_v1_instagram_v3_get_highlight_stories_get(highlight_id, reel_ids=reel_ids)
except ApiException as e:
    print("Exception when calling InstagramV3APIApi->get_highlight_stories_api_v1_instagram_v3_get_highlight_stories_get: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **highlight_id** | [**object**](.md)| 精选ID/Highlight ID (格式/format: highlight:xxx) | 
 **reel_ids** | [**object**](.md)| 精选ID列表，逗号分隔，如不提供则仅查询highlight_id/Highlight ID list, comma separated, if not provided only query highlight_id | [optional] 
...
# create an instance of the API class
api_instance = swagger_client.InstagramV3APIApi()
location_id = NULL # object | 地点ID/Location ID
show_nearby = NULL # object | 是否显示附近地点/Whether to show nearby places (optional)

try:
    # 获取地点详情/Get location info
    api_instance.get_location_info_api_v1_instagram_v3_get_location_info_get(location_id, show_nearby=show_nearby)
except ApiException as e:
    print("Exception when calling InstagramV3APIApi->get_location_info_api_v1_instagram_v3_get_location_info_get: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **location_id** | [**object**](.md)| 地点ID/Location ID | 
 **show_nearby** | [**object**](.md)| 是否显示附近地点/Whether to show nearby places | [optional] 
...
api_instance = swagger_client.InstagramV3APIApi()
location_id = NULL # object | 地点ID/Location ID
tab = NULL # object | 帖子类型: ranked(热门), recent(最新)/Post type: ranked(top), recent(latest) (optional)
page_size_override = NULL # object | 每页数量/Page size (optional)

try:
    # 获取地点相关帖子/Get location posts
    api_instance.get_location_posts_api_v1_instagram_v3_get_location_posts_get(location_id, tab=tab, page_size_override=page_size_override)
except ApiException as e:
    print("Exception when calling InstagramV3APIApi->get_location_posts_api_v1_instagram_v3_get_location_posts_get: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **location_id** | [**object**](.md)| 地点ID/Location ID | 
 **tab** | [**object**](.md)| 帖子类型: ranked(热门), recent(最新)/Post type: ranked(top), recent(latest) | [optional] 
 **page_size_override** | [**object**](.md)| 每页数量/Page size | [optional] 
...
# **get_post_comments_api_v1_instagram_v3_get_post_comments_get**
> get_post_comments_api_v1_instagram_v3_get_post_comments_get(media_id=media_id, code=code, url=url, min_id=min_id, sort_order=sort_order)
...
api_instance = swagger_client.InstagramV3APIApi()
media_id = NULL # object | 帖子媒体ID/Post media ID (optional)
code = NULL # object | 帖子短代码/Post shortcode (e.g., DUajw4YkorV) (optional)
url = NULL # object | 帖子URL/Post URL (optional)
min_id = NULL # object | 分页游标，首次请求不传，从上一次响应的 next_min_id 获取/Pagination cursor, omit for first request, get from previous response next_min_id (optional)
sort_order = NULL # object | 排序方式: popular(热门), newest(最新)/Sort order: popular, newest (optional)

try:
    # 获取帖子评论/Get post comments
    api_instance.get_post_comments_api_v1_instagram_v3_get_post_comments_get(media_id=media_id, code=code, url=url, min_id=min_id, sort_order=sort_order)
except ApiException as e:
    print("Exception when calling InstagramV3APIApi->get_post_comments_api_v1_instagram_v3_get_post_comments_get: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **media_id** | [**object**](.md)| 帖子媒体ID/Post media ID | [optional] 
 **code** | [**object**](.md)| 帖子短代码/Post shortcode (e.g., DUajw4YkorV) | [optional] 
 **url** | [**object**](.md)| 帖子URL/Post URL | [optional] 
 **min_id** | [**object**](.md)| 分页游标，首次请求不传，从上一次响应的 next_min_id 获取/Pagination cursor, omit for first request, get from previous response next_min_id | [optional] 
 **sort_order** | [**object**](.md)| 排序方式: popular(热门), newest(最新)/Sort order: popular, newest | [optional] 
...
try:
    # 获取帖子详情/Get post info (media_id or URL)
    api_instance.get_post_info_api_v1_instagram_v3_get_post_info_get(media_id=media_id, url=url)
except ApiException as e:
    print("Exception when calling InstagramV3APIApi->get_post_info_api_v1_instagram_v3_get_post_info_get: %s\n" % e)
```
...
api_instance = swagger_client.InstagramV3APIApi()
code = NULL # object | 帖子短代码/Post shortcode (optional)
url = NULL # object | 帖子URL（自动提取短代码）/Post URL (auto extract shortcode) (optional)

try:
    # 获取帖子详情(code)/Get post info by shortcode
    api_instance.get_post_info_by_code_api_v1_instagram_v3_get_post_info_by_code_get(code=code, url=url)
except ApiException as e:
    print("Exception when calling InstagramV3APIApi->get_post_info_by_code_api_v1_instagram_v3_get_post_info_by_code_get: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **code** | [**object**](.md)| 帖子短代码/Post shortcode | [optional] 
 **url** | [**object**](.md)| 帖子URL（自动提取短代码）/Post URL (auto extract shortcode) | [optional] 
...
# **get_post_oembed_api_v1_instagram_v3_get_post_oembed_get**
> get_post_oembed_api_v1_instagram_v3_get_post_oembed_get(url, hidecaption=hidecaption, maxwidth=maxwidth)
...
# create an instance of the API class
api_instance = swagger_client.InstagramV3APIApi()
url = NULL # object | Instagram帖子的完整URL/Full URL of Instagram post
hidecaption = NULL # object | 是否隐藏帖子文本/Whether to hide caption (optional)
maxwidth = NULL # object | 最大宽度（像素）/Max width in pixels (optional)

try:
    # 获取帖子oEmbed内嵌信息/Get post oEmbed info
    api_instance.get_post_oembed_api_v1_instagram_v3_get_post_oembed_get(url, hidecaption=hidecaption, maxwidth=maxwidth)
except ApiException as e:
    print("Exception when calling InstagramV3APIApi->get_post_oembed_api_v1_instagram_v3_get_post_oembed_get: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **url** | [**object**](.md)| Instagram帖子的完整URL/Full URL of Instagram post | 
 **hidecaption** | [**object**](.md)| 是否隐藏帖子文本/Whether to hide caption | [optional] 
 **maxwidth** | [**object**](.md)| 最大宽度（像素）/Max width in pixels | [optional] 
...
# create an instance of the API class
api_instance = swagger_client.InstagramV3APIApi()
first = NULL # object | 获取数量/Number of reels to fetch (optional)
after = NULL # object | 分页游标，首次请求不传，从上一次响应的 page_info.end_cursor 获取/Pagination cursor, omit for first request, get from previous response page_info.end_cursor (optional)

try:
    # 获取Reels推荐列表/Get recommended Reels feed
    api_instance.get_recommended_reels_api_v1_instagram_v3_get_recommended_reels_get(first=first, after=after)
except ApiException as e:
    print("Exception when calling InstagramV3APIApi->get_recommended_reels_api_v1_instagram_v3_get_recommended_reels_get: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **first** | [**object**](.md)| 获取数量/Number of reels to fetch | [optional] 
 **after** | [**object**](.md)| 分页游标，首次请求不传，从上一次响应的 page_info.end_cursor 获取/Pagination cursor, omit for first request, get from previous response page_info.end_cursor | [optional] 
...
username = NULL # object | 用户名/Username (optional)

try:
    # 获取用户账户简介/Get user about info
    api_instance.get_user_about_api_v1_instagram_v3_get_user_about_get(user_id=user_id, username=username)
except ApiException as e:
    print("Exception when calling InstagramV3APIApi->get_user_about_api_v1_instagram_v3_get_user_about_get: %s\n" % e)
```
 ...
 **username** | [**object**](.md)| 用户名/Username | [optional] 
...
# **get_user_brief_api_v1_instagram_v3_get_user_brief_get**
> get_user_brief_api_v1_instagram_v3_get_user_brief_get(user_id, username)
...
try:
    # 获取用户短详情/Get user brief info
    api_instance.get_user_brief_api_v1_instagram_v3_get_user_brief_get(user_id, username)
except ApiException as e:
    print("Exception when calling InstagramV3APIApi->get_user_brief_api_v1_instagram_v3_get_user_brief_get: %s\n" % e)
```
...
user_id = NULL # object | 用户ID/User ID (optional)
username = NULL # object | 用户名/Username (optional)
count = NULL # object | 每次获取数量/Number of users to fetch per request (optional)
max_id = NULL # object | 分页游标，首次请求不传，从上一次响应的 next_max_id 获取/Pagination cursor, omit for first request, get from previous response next_max_id (optional)

try:
    # 获取用户粉丝列表/Get user followers list
    api_instance.get_user_followers_api_v1_instagram_v3_get_user_followers_get(user_id=user_id, username=username, count=count, max_id=max_id)
except ApiException as e:
    print("Exception when calling InstagramV3APIApi->get_user_followers_api_v1_instagram_v3_get_user_followers_get: %s\n" % e)
```
 ...
 **user_id** | [**object**](.md)| 用户ID/User ID | [optional] 
 **username** | [**object**](.md)| 用户名/Username | [optional] 
 **count** | [**object**](.md)| 每次获取数量/Number of users to fetch per request | [optional] 
 **max_id** | [**object**](.md)| 分页游标，首次请求不传，从上一次响应的 next_max_id 获取/Pagination cursor, omit for first request, get from previous response next_max_id | [optional] 
...
# **get_user_following_api_v1_instagram_v3_get_user_following_get**
> get_user_following_api_v1_instagram_v3_get_user_following_get(user_id=user_id, username=username, count=count, max_id=max_id)
...
try:
    # 获取用户关注列表/Get user following list
    api_instance.get_user_following_api_v1_instagram_v3_get_user_following_get(user_id=user_id, username=username, count=count, max_id=max_id)
except ApiException as e:
    print("Exception when calling InstagramV3APIApi->get_user_following_api_v1_instagram_v3_get_user_following_get: %s\n" % e)
```
...
user_id = NULL # object | 用户ID/User ID (optional)
username = NULL # object | 用户名/Username (optional)
first = NULL # object | 获取数量/Number of highlights to fetch (optional)
after = NULL # object | 分页游标（从上次响应的page_info.end_cursor获取）/Pagination cursor (from previous response page_info.end_cursor) (optional)

try:
    # 获取用户精选Highlights列表/Get user highlights
    api_instance.get_user_highlights_api_v1_instagram_v3_get_user_highlights_get(user_id=user_id, username=username, first=first, after=after)
except ApiException as e:
    print("Exception when calling InstagramV3APIApi->get_user_highlights_api_v1_instagram_v3_get_user_highlights_get: %s\n" % e)
```
 ...
 **user_id** | [**object**](.md)| 用户ID/User ID | [optional] 
 **username** | [**object**](.md)| 用户名/Username | [optional] 
 **first** | [**object**](.md)| 获取数量/Number of highlights to fetch | [optional] 
 **after** | [**object**](.md)| 分页游标（从上次响应的page_info.end_cursor获取）/Pagination cursor (from previous response page_info.end_cursor) | [optional] 
...
# **get_user_posts_api_v1_instagram_v3_get_user_posts_get**
> get_user_posts_api_v1_instagram_v3_get_user_posts_get(username=username, user_id=user_id, first=first, after=after)
...
username = NULL # object | 用户名/Username (optional)
user_id = NULL # object | 用户ID/User ID (optional)
first = NULL # object | 获取帖子数量/Number of posts to fetch (optional)
after = NULL # object | 分页游标（从上次响应的page_info.end_cursor获取）/Pagination cursor (from previous response page_info.end_cursor) (optional)

try:
    # 获取用户帖子列表/Get user posts
    api_instance.get_user_posts_api_v1_instagram_v3_get_user_posts_get(username=username, user_id=user_id, first=first, after=after)
except ApiException as e:
    print("Exception when calling InstagramV3APIApi->get_user_posts_api_v1_instagram_v3_get_user_posts_get: %s\n" % e)
```
 ...
 **username** | [**object**](.md)| 用户名/Username | [optional] 
 **user_id** | [**object**](.md)| 用户ID/User ID | [optional] 
 **first** | [**object**](.md)| 获取帖子数量/Number of posts to fetch | [optional] 
 **after** | [**object**](.md)| 分页游标（从上次响应的page_info.end_cursor获取）/Pagination cursor (from previous response page_info.end_cursor) | [optional] 
...
try:
    # 获取用户信息/Get user profile
    api_instance.get_user_profile_api_v1_instagram_v3_get_user_profile_get(user_id=user_id, username=username)
except ApiException as e:
    print("Exception when calling InstagramV3APIApi->get_user_profile_api_v1_instagram_v3_get_user_profile_get: %s\n" % e)
```
...
try:
    # 获取用户Reels列表/Get user reels
    api_instance.get_user_reels_api_v1_instagram_v3_get_user_reels_get(user_id=user_id, username=username, first=first, after=after)
except ApiException as e:
    print("Exception when calling InstagramV3APIApi->get_user_reels_api_v1_instagram_v3_get_user_reels_get: %s\n" % e)
```
...
# **get_user_stories_api_v1_instagram_v3_get_user_stories_get**
> get_user_stories_api_v1_instagram_v3_get_user_stories_get(user_id=user_id, username=username, reel_ids=reel_ids)
...
user_id = NULL # object | 用户ID/User ID (optional)
username = NULL # object | 用户名/Username (optional)
reel_ids = NULL # object | 用户ID列表，逗号分隔，可同时获取多个用户的Stories（如不提供则仅查询user_id）/User ID list, comma separated, fetch multiple users' stories at once (if not provided, only queries user_id) (optional)

try:
    # 获取用户Stories（快拍）/Get user stories
    api_instance.get_user_stories_api_v1_instagram_v3_get_user_stories_get(user_id=user_id, username=username, reel_ids=reel_ids)
except ApiException as e:
    print("Exception when calling InstagramV3APIApi->get_user_stories_api_v1_instagram_v3_get_user_stories_get: %s\n" % e)
```
 ...
 **user_id** | [**object**](.md)| 用户ID/User ID | [optional] 
 **username** | [**object**](.md)| 用户名/Username | [optional] 
 **reel_ids** | [**object**](.md)| 用户ID列表，逗号分隔，可同时获取多个用户的Stories（如不提供则仅查询user_id）/User ID list, comma separated, fetch multiple users&#39; stories at once (if not provided, only queries user_id) | [optional] 
...
try:
    # 获取用户被标记的帖子/Get user tagged posts
    api_instance.get_user_tagged_posts_api_v1_instagram_v3_get_user_tagged_posts_get(user_id=user_id, username=username, first=first, after=after)
except ApiException as e:
    print("Exception when calling InstagramV3APIApi->get_user_tagged_posts_api_v1_instagram_v3_get_user_tagged_posts_get: %s\n" % e)
```
...
try:
    # 搜索话题标签/Search hashtags
    api_instance.search_hashtags_api_v1_instagram_v3_search_hashtags_get(query)
except ApiException as e:
    print("Exception when calling InstagramV3APIApi->search_hashtags_api_v1_instagram_v3_search_hashtags_get: %s\n" % e)
```
...
try:
    # 搜索地点/Search places
    api_instance.search_places_api_v1_instagram_v3_search_places_get(query)
except ApiException as e:
    print("Exception when calling InstagramV3APIApi->search_places_api_v1_instagram_v3_search_places_get: %s\n" % e)
```
...
try:
    # 搜索用户/Search users
    api_instance.search_users_api_v1_instagram_v3_search_users_get(query)
except ApiException as e:
    print("Exception when calling InstagramV3APIApi->search_users_api_v1_instagram_v3_search_users_get: %s\n" % e)
```
...
# create an instance of the API class
api_instance = swagger_client.InstagramV3APIApi()
comment_id = NULL # object | 帖子媒体ID/Post media ID

try:
    # 翻译评论/帖子文本/Translate comment or caption
    api_instance.translate_comment_api_v1_instagram_v3_translate_comment_get(comment_id)
except ApiException as e:
    print("Exception when calling InstagramV3APIApi->translate_comment_api_v1_instagram_v3_translate_comment_get: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **comment_id** | [**object**](.md)| 帖子媒体ID/Post media ID | 

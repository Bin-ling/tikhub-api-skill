# swagger_client.TikTokCreatorAPIApi

All URIs are relative to *https://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_account_health_status_api_v1_tiktok_creator_get_account_health_status_post**](TikTokCreatorAPIApi.md#get_account_health_status_api_v1_tiktok_creator_get_account_health_status_post) | **POST** /api/v1/tiktok/creator/get_account_health_status | 获取创作者账号健康状态/Get Creator Account Health Status
[**get_account_insights_overview_api_v1_tiktok_creator_get_account_insights_overview_post**](TikTokCreatorAPIApi.md#get_account_insights_overview_api_v1_tiktok_creator_get_account_insights_overview_post) | **POST** /api/v1/tiktok/creator/get_account_insights_overview | 获取创作者账号概览/Get Creator Account Overview
[**get_account_violation_list_api_v1_tiktok_creator_get_account_violation_list_post**](TikTokCreatorAPIApi.md#get_account_violation_list_api_v1_tiktok_creator_get_account_violation_list_post) | **POST** /api/v1/tiktok/creator/get_account_violation_list | 获取创作者账号违规记录列表/Get Creator Account Violation Record List
[**get_creator_account_info_api_v1_tiktok_creator_get_creator_account_info_post**](TikTokCreatorAPIApi.md#get_creator_account_info_api_v1_tiktok_creator_get_creator_account_info_post) | **POST** /api/v1/tiktok/creator/get_creator_account_info | 获取创作者账号信息/Get Creator Account Info
[**get_live_overview_api_v1_tiktok_creator_get_live_analytics_summary_post**](TikTokCreatorAPIApi.md#get_live_overview_api_v1_tiktok_creator_get_live_analytics_summary_post) | **POST** /api/v1/tiktok/creator/get_live_analytics_summary | 获取创作者直播概览/Get Creator Live Overview
[**get_product_analytics_list_api_v1_tiktok_creator_get_product_analytics_list_post**](TikTokCreatorAPIApi.md#get_product_analytics_list_api_v1_tiktok_creator_get_product_analytics_list_post) | **POST** /api/v1/tiktok/creator/get_product_analytics_list | 获取创作者商品列表分析/Get Creator Product List Analytics
[**get_product_related_videos_api_v1_tiktok_creator_get_product_related_videos_post**](TikTokCreatorAPIApi.md#get_product_related_videos_api_v1_tiktok_creator_get_product_related_videos_post) | **POST** /api/v1/tiktok/creator/get_product_related_videos | 获取同款商品关联视频/Get Product Related Videos
[**get_showcase_product_list_api_v1_tiktok_creator_get_showcase_product_list_post**](TikTokCreatorAPIApi.md#get_showcase_product_list_api_v1_tiktok_creator_get_showcase_product_list_post) | **POST** /api/v1/tiktok/creator/get_showcase_product_list | 获取橱窗商品列表/Get Showcase Product List
[**get_video_analytics_summary_api_v1_tiktok_creator_get_video_analytics_summary_post**](TikTokCreatorAPIApi.md#get_video_analytics_summary_api_v1_tiktok_creator_get_video_analytics_summary_post) | **POST** /api/v1/tiktok/creator/get_video_analytics_summary | 获取创作者视频概览/Get Creator Video Overview
[**get_video_associated_product_list_api_v1_tiktok_creator_get_video_associated_product_list_post**](TikTokCreatorAPIApi.md#get_video_associated_product_list_api_v1_tiktok_creator_get_video_associated_product_list_post) | **POST** /api/v1/tiktok/creator/get_video_associated_product_list | 获取视频关联商品列表/Get Video Associated Product List
[**get_video_audience_stats_api_v1_tiktok_creator_get_video_audience_stats_post**](TikTokCreatorAPIApi.md#get_video_audience_stats_api_v1_tiktok_creator_get_video_audience_stats_post) | **POST** /api/v1/tiktok/creator/get_video_audience_stats | 获取视频受众分析数据/Get Video Audience Analysis Data
[**get_video_detailed_stats_api_v1_tiktok_creator_get_video_detailed_stats_post**](TikTokCreatorAPIApi.md#get_video_detailed_stats_api_v1_tiktok_creator_get_video_detailed_stats_post) | **POST** /api/v1/tiktok/creator/get_video_detailed_stats | 获取视频详细分段统计数据/Get Video Detailed Statistics
[**get_video_list_api_v1_tiktok_creator_get_video_list_analytics_post**](TikTokCreatorAPIApi.md#get_video_list_api_v1_tiktok_creator_get_video_list_analytics_post) | **POST** /api/v1/tiktok/creator/get_video_list_analytics | 获取创作者视频列表分析/Get Creator Video List Analytics
[**get_video_to_product_stats_api_v1_tiktok_creator_get_video_to_product_stats_post**](TikTokCreatorAPIApi.md#get_video_to_product_stats_api_v1_tiktok_creator_get_video_to_product_stats_post) | **POST** /api/v1/tiktok/creator/get_video_to_product_stats | 获取视频与商品关联统计数据/Get Video-Product Association Statistics


# **get_account_health_status_api_v1_tiktok_creator_get_account_health_status_post**
> get_account_health_status_api_v1_tiktok_creator_get_account_health_status_post()
...
api_instance = swagger_client.TikTokCreatorAPIApi()

try:
    # 获取创作者账号健康状态/Get Creator Account Health Status
    api_instance.get_account_health_status_api_v1_tiktok_creator_get_account_health_status_post()
except ApiException as e:
    print("Exception when calling TikTokCreatorAPIApi->get_account_health_status_api_v1_tiktok_creator_get_account_health_status_post: %s\n" % e)
```
...
try:
    # 获取创作者账号概览/Get Creator Account Overview
    api_instance.get_account_insights_overview_api_v1_tiktok_creator_get_account_insights_overview_post()
except ApiException as e:
    print("Exception when calling TikTokCreatorAPIApi->get_account_insights_overview_api_v1_tiktok_creator_get_account_insights_overview_post: %s\n" % e)
```
...
try:
    # 获取创作者账号违规记录列表/Get Creator Account Violation Record List
    api_instance.get_account_violation_list_api_v1_tiktok_creator_get_account_violation_list_post()
except ApiException as e:
    print("Exception when calling TikTokCreatorAPIApi->get_account_violation_list_api_v1_tiktok_creator_get_account_violation_list_post: %s\n" % e)
```
...
# **get_creator_account_info_api_v1_tiktok_creator_get_creator_account_info_post**
> get_creator_account_info_api_v1_tiktok_creator_get_creator_account_info_post()
...
try:
    # 获取创作者账号信息/Get Creator Account Info
    api_instance.get_creator_account_info_api_v1_tiktok_creator_get_creator_account_info_post()
except ApiException as e:
    print("Exception when calling TikTokCreatorAPIApi->get_creator_account_info_api_v1_tiktok_creator_get_creator_account_info_post: %s\n" % e)
```
...
# **get_live_overview_api_v1_tiktok_creator_get_live_analytics_summary_post**
> get_live_overview_api_v1_tiktok_creator_get_live_analytics_summary_post()
...
try:
    # 获取创作者直播概览/Get Creator Live Overview
    api_instance.get_live_overview_api_v1_tiktok_creator_get_live_analytics_summary_post()
except ApiException as e:
    print("Exception when calling TikTokCreatorAPIApi->get_live_overview_api_v1_tiktok_creator_get_live_analytics_summary_post: %s\n" % e)
```
...
try:
    # 获取创作者商品列表分析/Get Creator Product List Analytics
    api_instance.get_product_analytics_list_api_v1_tiktok_creator_get_product_analytics_list_post()
except ApiException as e:
    print("Exception when calling TikTokCreatorAPIApi->get_product_analytics_list_api_v1_tiktok_creator_get_product_analytics_list_post: %s\n" % e)
```
...
# **get_product_related_videos_api_v1_tiktok_creator_get_product_related_videos_post**
> get_product_related_videos_api_v1_tiktok_creator_get_product_related_videos_post()
...
try:
    # 获取同款商品关联视频/Get Product Related Videos
    api_instance.get_product_related_videos_api_v1_tiktok_creator_get_product_related_videos_post()
except ApiException as e:
    print("Exception when calling TikTokCreatorAPIApi->get_product_related_videos_api_v1_tiktok_creator_get_product_related_videos_post: %s\n" % e)
```
...
try:
    # 获取橱窗商品列表/Get Showcase Product List
    api_instance.get_showcase_product_list_api_v1_tiktok_creator_get_showcase_product_list_post()
except ApiException as e:
    print("Exception when calling TikTokCreatorAPIApi->get_showcase_product_list_api_v1_tiktok_creator_get_showcase_product_list_post: %s\n" % e)
```
...
# **get_video_analytics_summary_api_v1_tiktok_creator_get_video_analytics_summary_post**
> get_video_analytics_summary_api_v1_tiktok_creator_get_video_analytics_summary_post()
...
try:
    # 获取创作者视频概览/Get Creator Video Overview
    api_instance.get_video_analytics_summary_api_v1_tiktok_creator_get_video_analytics_summary_post()
except ApiException as e:
    print("Exception when calling TikTokCreatorAPIApi->get_video_analytics_summary_api_v1_tiktok_creator_get_video_analytics_summary_post: %s\n" % e)
```
...
try:
    # 获取视频关联商品列表/Get Video Associated Product List
    api_instance.get_video_associated_product_list_api_v1_tiktok_creator_get_video_associated_product_list_post()
except ApiException as e:
    print("Exception when calling TikTokCreatorAPIApi->get_video_associated_product_list_api_v1_tiktok_creator_get_video_associated_product_list_post: %s\n" % e)
```
...
# **get_video_audience_stats_api_v1_tiktok_creator_get_video_audience_stats_post**
> get_video_audience_stats_api_v1_tiktok_creator_get_video_audience_stats_post()
...
try:
    # 获取视频受众分析数据/Get Video Audience Analysis Data
    api_instance.get_video_audience_stats_api_v1_tiktok_creator_get_video_audience_stats_post()
except ApiException as e:
    print("Exception when calling TikTokCreatorAPIApi->get_video_audience_stats_api_v1_tiktok_creator_get_video_audience_stats_post: %s\n" % e)
```
...
# **get_video_detailed_stats_api_v1_tiktok_creator_get_video_detailed_stats_post**
> get_video_detailed_stats_api_v1_tiktok_creator_get_video_detailed_stats_post()
...
try:
    # 获取视频详细分段统计数据/Get Video Detailed Statistics
    api_instance.get_video_detailed_stats_api_v1_tiktok_creator_get_video_detailed_stats_post()
except ApiException as e:
    print("Exception when calling TikTokCreatorAPIApi->get_video_detailed_stats_api_v1_tiktok_creator_get_video_detailed_stats_post: %s\n" % e)
```
...
try:
    # 获取创作者视频列表分析/Get Creator Video List Analytics
    api_instance.get_video_list_api_v1_tiktok_creator_get_video_list_analytics_post()
except ApiException as e:
    print("Exception when calling TikTokCreatorAPIApi->get_video_list_api_v1_tiktok_creator_get_video_list_analytics_post: %s\n" % e)
```
...
# **get_video_to_product_stats_api_v1_tiktok_creator_get_video_to_product_stats_post**
> get_video_to_product_stats_api_v1_tiktok_creator_get_video_to_product_stats_post()
...
try:
    # 获取视频与商品关联统计数据/Get Video-Product Association Statistics
    api_instance.get_video_to_product_stats_api_v1_tiktok_creator_get_video_to_product_stats_post()
except ApiException as e:
    print("Exception when calling TikTokCreatorAPIApi->get_video_to_product_stats_api_v1_tiktok_creator_get_video_to_product_stats_post: %s\n" % e)
```
